...
namespace {
	 ...
	 * @param string $delimiter <p>The token that separates values for each field in each element of <code>rows</code>. Default is <code>TAB</code>.</p>
	 * @param string $null_as <p>How SQL <code>NULL</code> values are represented in the <code>rows</code>. Default is \N ("\\N").</p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param string $delimiter <p>The token that separates values for each field in each element of <code>rows</code>. Default is <code>TAB</code>.</p>
	 * @param string $null_as <p>How SQL <code>NULL</code> values are represented in the <code>rows</code>. Default is \N ("\\N").</p>
	 * @return array <p>An <code>array</code> with one element for each line of <code>COPY</code> data. It returns <b><code>false</code></b> on failure.</p>
	 ...
	 * @param resource $connection <p>PostgreSQL database connection resource. When <code>connection</code> is not present, the default connection is used. The default connection is the last connection made by <code>pg_connect()</code> or <code>pg_pconnect()</code>. When there is no default connection, it raises <code>E_WARNING</code> and returns <b><code>false</code></b>.</p>
	 * @param string $data <p>A <code>string</code> containing text to be escaped.</p>
	 * @return string <p>A <code>string</code> containing the escaped data.</p>
	 ...
	 * @return resource|false <p>A query result resource on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param resource $result <p>PostgreSQL query result resource, returned by <code>pg_query()</code>, <code>pg_query_params()</code> or <code>pg_execute()</code> (among others).</p>
	 * @param int $row <p>Row number in result to fetch. Rows are numbered from 0 upwards. If omitted or <b><code>null</code></b>, the next row is fetched.</p>
	 * @return array <p>An <code>array</code> indexed associatively (by field name). Each value in the <code>array</code> is represented as a <code>string</code>. Database <code>NULL</code> values are returned as <b><code>null</code></b>.</p><p><b><code>false</code></b> is returned if <code>row</code> exceeds the number of rows in the set, there are no more rows, or on any other error.</p>
	 ...
	 * @return object <p>An <code>object</code> with one attribute for each field name in the result. Database <code>NULL</code> values are returned as <b><code>null</code></b>.</p><p><b><code>false</code></b> is returned if <code>row</code> exceeds the number of rows in the set, there are no more rows, or on any other error.</p>
	 ...
	 * @since PHP 4 >= 4.2.0, PHP 5, PHP 7
	 */
	function pg_fetch_result($result, int $row, mixed $field): string|false|null {}
	 ...
	 * @param resource $result <p>PostgreSQL query result resource, returned by <code>pg_query()</code>, <code>pg_query_params()</code> or <code>pg_execute()</code> (among others).</p>
	 * @param int $row <p>Row number in result to fetch. Rows are numbered from 0 upwards. If omitted or <b><code>null</code></b>, the next row is fetched.</p>
	 * @return array <p>An <code>array</code>, indexed from 0 upwards, with each value represented as a <code>string</code>. Database <code>NULL</code> values are returned as <b><code>null</code></b>.</p><p><b><code>false</code></b> is returned if <code>row</code> exceeds the number of rows in the set, there are no more rows, or on any other error.</p>
	 ...
	 * <p><b>pg_field_is_null()</b> tests if a field in a PostgreSQL result resource is SQL <code>NULL</code> or not.</p><p><b>Note</b>:</p><p>This function used to be called <b>pg_fieldisnull()</b>.</p>
	 * @param resource $result <p>PostgreSQL query result resource, returned by <code>pg_query()</code>, <code>pg_query_params()</code> or <code>pg_execute()</code> (among others).</p>
	 ...
	 * @param resource $connection <p>PostgreSQL database connection resource.</p>
	 * @return mixed <p>Returns <b><code>true</code></b> if the flush was successful or no data was waiting to be flushed, <code>0</code> if part of the pending data was flushed but more remains or <b><code>false</code></b> on failure.</p>
	 ...
	 * @return array <p>An <code>array</code> containing the <code>NOTIFY</code> message name and backend PID. As of PHP 5.4.0 and if supported by the server, the array also contains the server version and the payload. Otherwise if no <code>NOTIFY</code> is waiting, then <b><code>false</code></b> is returned.</p>
	 ...
	 * <p><b>pg_insert()</b> inserts the values of <code>assoc_array</code> into the table specified by <code>table_name</code>. If <code>options</code> is specified, <code>pg_convert()</code> is applied to <code>assoc_array</code> with the specified options.</p><p>If <code>options</code> is specified, <code>pg_convert()</code> is applied to <code>assoc_array</code> with the specified flags.</p><p>By default <b>pg_insert()</b> passes raw values. Values must be escaped or PGSQL_DML_ESCAPE option must be specified. PGSQL_DML_ESCAPE quotes and escapes parameters/identifiers. Therefore, table/column names became case sensitive.</p><p>Note that neither escape nor prepared query can protect LIKE query, JSON, Array, Regex, etc. These parameters should be handled according to their contexts. i.e. Escape/validate values.</p>
	 * @param resource $connection <p>PostgreSQL database connection resource.</p>
	 ...
	 * @return mixed <p>A <code>string</code> containing the last notice on the given <code>connection</code> with <b><code>PGSQL_NOTICE_LAST</code></b>, an <code>array</code> with <b><code>PGSQL_NOTICE_ALL</code></b>, a <code>bool</code> with <b><code>PGSQL_NOTICE_CLEAR</code></b>, or <b><code>false</code></b> on error.</p>
	...
	/**
	 * Select records
	 * <p><b>pg_select()</b> selects records specified by <code>assoc_array</code> which has <code>field=&gt;value</code>. For a successful query, it returns an array containing all records and fields that match the condition specified by <code>assoc_array</code>.</p><p>If <code>options</code> is specified, <code>pg_convert()</code> is applied to <code>assoc_array</code> with the specified flags.</p><p>By default <b>pg_select()</b> passes raw values. Values must be escaped or PGSQL_DML_ESCAPE option must be specified. PGSQL_DML_ESCAPE quotes and escapes parameters/identifiers. Therefore, table/column names became case sensitive.</p><p>Note that neither escape nor prepared query can protect LIKE query, JSON, Array, Regex, etc. These parameters should be handled according to their contexts. i.e. Escape/validate values.</p>
	 * @param resource $connection <p>PostgreSQL database connection resource.</p>
	...
	/**
	 * Update table
	 * <p><b>pg_update()</b> updates records that matches <code>condition</code> with <code>data</code>. If <code>options</code> is specified, <code>pg_convert()</code> is applied to <code>data</code> with specified options.</p><p><b>pg_update()</b> updates records specified by <code>assoc_array</code> which has <code>field=&gt;value</code>.</p><p>If <code>options</code> is specified, <code>pg_convert()</code> is applied to <code>assoc_array</code> with the specified flags.</p><p>By default <b>pg_update()</b> passes raw values. Values must be escaped or PGSQL_DML_ESCAPE option must be specified. PGSQL_DML_ESCAPE quotes and escapes parameters/identifiers. Therefore, table/column names became case sensitive.</p><p>Note that neither escape nor prepared query can protect LIKE query, JSON, Array, Regex, etc. These parameters should be handled according to their contexts. i.e. Escape/validate values.</p>
	 * @param resource $connection <p>PostgreSQL database connection resource.</p>
	 ...
	 * @param resource $connection <p>PostgreSQL database connection resource. When <code>connection</code> is not present, the default connection is used. The default connection is the last connection made by <code>pg_connect()</code> or <code>pg_pconnect()</code>.</p>
	 * @return array <p>Returns an array with <code>client</code>, <code>protocol</code> and <code>server</code> keys and values (if available). Returns <b><code>false</code></b> on error or invalid connection.</p>
	...
	/**
	 * Passed to <code>pg_insert()</code>, <code>pg_select()</code>, <code>pg_update()</code> and <code>pg_delete()</code>. Apply escape to all parameters instead of calling <code>pg_convert()</code> internally. This option omits meta data look up. Query could be as fast as <code>pg_query()</code> and <code>pg_send_query()</code>. Available since PHP 5.6.0.
	 */
	 ...
	 */
	define('PGSQL_LIBPQ_VERSION', '12.4 (Ubuntu 12.4-0ubuntu0.20.04.1)');
	 ...
	 */
	define('PGSQL_LIBPQ_VERSION_STR', 'PostgreSQL 12.4 (Ubuntu 12.4-0ubuntu0.20.04.1) on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 9.3.0-10ubuntu2) 9.3.0, 64-bit');
	...
	/**
	 * Returned by <code>pg_connect_poll()</code> to indicate that the connection is currently active. Available since PHP 5.6.0.
	 */
	define('PGSQL_POLLING_ACTIVE', 4);

	/**
	 * Returned by <code>pg_connect_poll()</code> to indicate that the connection attempt failed. Available since PHP 5.6.0.
	 */
	define('PGSQL_POLLING_FAILED', 0);

	/**
	 * Returned by <code>pg_connect_poll()</code> to indicate that the connection is ready to be used. Available since PHP 5.6.0.
	 */
	define('PGSQL_POLLING_OK', 3);

	/**
	 * Returned by <code>pg_connect_poll()</code> to indicate that the connection is waiting for the PostgreSQL socket to be readable. Available since PHP 5.6.0.
	 */
	define('PGSQL_POLLING_READING', 1);

	/**
	 * Returned by <code>pg_connect_poll()</code> to indicate that the connection is waiting for the PostgreSQL socket to be writable. Available since PHP 5.6.0.
	 */
