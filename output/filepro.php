...
namespace {
	 ...
	 * <p>This reads and verifies the map file, storing the field count and info.</p><p>No locking is done, so you should avoid modifying your filePro database while it may be opened in PHP.</p><p><b>Note</b>: When safe mode is enabled, PHP checks whether the files or directories being operated upon have the same UID (owner) as the script that is being executed.</p>
	 ...
	 * <p>Returns the data from the specified location in the database.</p><p><b>Note</b>: When safe mode is enabled, PHP checks whether the files or directories being operated upon have the same UID (owner) as the script that is being executed.</p>
	 ...
	 * <p>Returns the number of rows in the opened filePro database.</p><p><b>Note</b>: When safe mode is enabled, PHP checks whether the files or directories being operated upon have the same UID (owner) as the script that is being executed.</p>
