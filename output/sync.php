...
namespace {
	...
	class SyncSemaphore {
		 ...
		 * @param bool $autounlock <p>Specifies whether or not to automatically unlock the semaphore at the conclusion of the PHP script.</p> <p><b>Warning</b></p> <p>If an object is: A named semaphore with an autounlock of FALSE, the object is locked, and the PHP script concludes before the object is unlocked, then the underlying semaphore will end up in an inconsistent state.</p>
	...
	class SyncSharedMemory {
		 ...
		 * @param string $string <p>The data to write to shared memoy.</p> <p><b>Note</b>:</p><p>If the size of the data exceeds the size of the shared memory, the number of bytes written returned will be less than the length of the input.</p>
