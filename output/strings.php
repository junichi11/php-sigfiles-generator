...
namespace {
	 ...
	 * @param string $locales <p>(Optional string or array parameters to try as locale settings until success.)</p>
	 ...
	 * @since PHP 4, PHP 5, PHP 7
	 */
	function setlocale(int $category, string $locale, string ...$locales): string {}
