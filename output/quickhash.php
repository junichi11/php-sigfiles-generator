...
namespace {
	...
	/**
	 * <p>This class wraps around a hash containing integer numbers, where the values are also integer numbers. Hashes are also available as implementation of the <code>ArrayAccess</code> interface.</p>
	 * <p>Hashes can also be iterated over with <code>foreach</code> as the <code>Iterator</code> interface is implemented as well. The order of which elements are returned in is not guaranteed.</p>
	...
	class QuickHashIntHash {
		...
		/**
		 * @var int <p>If enabled, adding duplicate elements to a set (through either <code>QuickHashIntHash::add()</code> or <code>QuickHashIntHash::loadFromFile()</code>) will result in those elements to be dropped from the set. This will take up extra time, so only used when it is required.</p>
		 * @link https://php.net/manual/en/class.quickhashinthash.php
		 */
		 ...
		 * <p>This constructor creates a new <code>QuickHashIntHash</code>. The size is the amount of bucket lists to create. The more lists there are, the less collisions you will have. Options are also supported.</p>
		 * @param int $size <p>The amount of bucket lists to configure. The number you pass in will be automatically rounded up to the next power of two. It is also automatically limited from <code>64</code> to <code>4194304</code>.</p>
		 * @param int $options <p>The options that you can pass in are: <b><code>QuickHashIntHash::CHECK_FOR_DUPES</code></b>, which makes sure no duplicate entries are added to the hash; <b><code>QuickHashIntHash::DO_NOT_USE_ZEND_ALLOC</code></b> to not use PHP's internal memory manager as well as one of <b><code>QuickHashIntHash::HASHER_NO_HASH</code></b>, <b><code>QuickHashIntHash::HASHER_JENKINS1</code></b> or <b><code>QuickHashIntHash::HASHER_JENKINS2</code></b>. These last three configure which hashing algorithm to use. All options can be combined using bitmasks.</p>
		 * @return self <p>Returns a new <code>QuickHashIntHash</code> object.</p>
		 ...
		 * <p>This method adds a new entry to the hash, and returns whether the entry was added. Entries are by default always added unless <b><code>QuickHashIntHash::CHECK_FOR_DUPES</code></b> has been passed when the hash was created.</p>
		 ...
		 * @param int $key <p>The key of the entry to retrieve.</p>
		 ...
		 * <p>This factory method creates a new hash from a definition file on disk. The file format consists of a signature <code>'QH\0x11\0'</code>, the number of elements as a 32 bit signed integer in system Endianness, followed by 32 bit signed integers packed together in the Endianness that the system that the code runs on uses. For each hash element there are two 32 bit signed integers stored. The first of each element is the key, and the second is the value belonging to the key. An example could be:</p><p></p><p><b>Example #1 QuickHash IntHash file format</b></p><p></p><p><b>Example #2 QuickHash IntHash file format</b></p>
		 * @param string $filename <p>The filename of the file to read the hash from.</p>
		 * @param int $options <p>The same options that the class' constructor takes; except that the size option is ignored. It is automatically calculated to be the same as the number of entries in the hash, rounded up to the nearest power of two with a maximum limit of <code>4194304</code>.</p>
		 * @return QuickHashIntHash <p>Returns a new <code>QuickHashIntHash</code>.</p>
		 ...
		 * <p>This method stores an existing hash to a file on disk, in the same format that <code>QuickHashIntHash::loadFromFile()</code> can read.</p>
		 ...
		 * <p>This method returns a serialized version of the hash in the same format that <code>QuickHashIntHash::loadFromString()</code> can read.</p>
		 ...
		 * <p>This method updates an entry with a new value, and returns whether the entry was update. If there are duplicate keys, only the first found element will get an updated value. Use <b><code>QuickHashIntHash::CHECK_FOR_DUPES</code></b> during hash creation to prevent duplicate keys from being part of the hash.</p>
		 * @param int $key <p>The key of the entry to update.</p>
	 ...
	 * <p>Sets can also be iterated over with <code>foreach</code> as the <code>Iterator</code> interface is implemented as well. The order of which elements are returned in is not guaranteed.</p>
	...
	class QuickHashIntSet {
		...
		/**
		 * @var int <p>If enabled, adding duplicate elements to a set (through either <code>QuickHashIntSet::add()</code> or <code>QuickHashIntSet::loadFromFile()</code>) will result in those elements to be dropped from the set. This will take up extra time, so only used when it is required.</p>
		 * @link https://php.net/manual/en/class.quickhashintset.php
		 */
		const CHECK_FOR_DUPES = 1;
		 ...
		 * <p>This constructor creates a new <code>QuickHashIntSet</code>. The size is the amount of bucket lists to create. The more lists there are, the less collisions you will have. Options are also supported.</p>
		 * @param int $size <p>The amount of bucket lists to configure. The number you pass in will be automatically rounded up to the next power of two. It is also automatically limited from <code>4</code> to <code>4194304</code>.</p>
		 * @param int $options <p>The options that you can pass in are: <b><code>QuickHashIntSet::CHECK_FOR_DUPES</code></b>, which makes sure no duplicate entries are added to the set; <b><code>QuickHashIntSet::DO_NOT_USE_ZEND_ALLOC</code></b> to not use PHP's internal memory manager as well as one of <b><code>QuickHashIntSet::HASHER_NO_HASH</code></b>, <b><code>QuickHashIntSet::HASHER_JENKINS1</code></b> or <b><code>QuickHashIntSet::HASHER_JENKINS2</code></b>. These last three configure which hashing algorithm to use. All options can be combined using bitmasks.</p>
		 * @return self <p>Returns a new <code>QuickHashIntSet</code> object.</p>
		 ...
		 * <p>This method adds a new entry to the set, and returns whether the entry was added. Entries are by default always added unless <b><code>QuickHashIntSet::CHECK_FOR_DUPES</code></b> has been passed when the set was created.</p>
		 * @param int $key <p>The key of the entry to add.</p>
		 * @return bool <p><b><code>true</code></b> when the entry was added, and <b><code>false</code></b> if the entry was not added.</p>
		 ...
		 * @param int $size <p>The amount of bucket lists to configure. The number you pass in will be automatically rounded up to the next power of two. It is also automatically limited from <code>4</code> to <code>4194304</code>.</p>
		 * @param int $options <p>The same options that the class' constructor takes; except that the size option is ignored. It is automatically calculated to be the same as the number of entries in the set, rounded up to the nearest power of two with a maximum limit of <code>4194304</code>.</p>
		 * @return QuickHashIntSet <p>Returns a new <code>QuickHashIntSet</code>.</p>
		 ...
		 * @param int $size <p>The amount of bucket lists to configure. The number you pass in will be automatically rounded up to the next power of two. It is also automatically limited from <code>4</code> to <code>4194304</code>.</p>
		 * @param int $options <p>The same options that the class' constructor takes; except that the size option is ignored. It is automatically calculated to be the same as the number of entries in the set, rounded up to the nearest power of two automatically limited from <code>64</code> to <code>4194304</code>.</p>
		 * @return QuickHashIntSet <p>Returns a new <code>QuickHashIntSet</code>.</p>
		 ...
		 * <p>This method stores an existing set to a file on disk, in the same format that <code>QuickHashIntSet::loadFromFile()</code> can read.</p>
		 * @param string $filename <p>The filename of the file to store the hash in.</p>
		 * @return void <p>No value is returned.</p>
		 ...
		 * <p>This method returns a serialized version of the set in the same format that <code>QuickHashIntSet::loadFromString()</code> can read.</p>
	...
	/**
	 * <p>This class wraps around a hash containing integer numbers, where the values are strings. Hashes are also available as implementation of the <code>ArrayAccess</code> interface.</p>
	 * <p>Hashes can also be iterated over with <code>foreach</code> as the <code>Iterator</code> interface is implemented as well. The order of which elements are returned in is not guaranteed.</p>
	...
	class QuickHashIntStringHash {
		...
		/**
		 * @var int <p>If enabled, adding duplicate elements to a set (through either <code>QuickHashIntStringHash::add()</code> or <code>QuickHashIntStringHash::loadFromFile()</code>) will result in those elements to be dropped from the set. This will take up extra time, so only used when it is required.</p>
		 * @link https://php.net/manual/en/class.quickhashintstringhash.php
		 */
		const CHECK_FOR_DUPES = 1;
		 ...
		 * <p>This constructor creates a new <code>QuickHashIntStringHash</code>. The size is the amount of bucket lists to create. The more lists there are, the less collisions you will have. Options are also supported.</p>
		 * @param int $size <p>The amount of bucket lists to configure. The number you pass in will be automatically rounded up to the next power of two. It is also automatically limited from <code>64</code> to <code>4194304</code>.</p>
		 * @param int $options <p>The options that you can pass in are: <b><code>QuickHashIntStringHash::CHECK_FOR_DUPES</code></b>, which makes sure no duplicate entries are added to the hash; <b><code>QuickHashIntStringHash::DO_NOT_USE_ZEND_ALLOC</code></b> to not use PHP's internal memory manager as well as one of <b><code>QuickHashIntStringHash::HASHER_NO_HASH</code></b>, <b><code>QuickHashIntStringHash::HASHER_JENKINS1</code></b> or <b><code>QuickHashIntStringHash::HASHER_JENKINS2</code></b>. These last three configure which hashing algorithm to use. All options can be combined using bitmasks.</p>
		 * @return self <p>Returns a new <code>QuickHashIntStringHash</code> object.</p>
		...
		/**
		 * This method adds a new entry to the hash
		 * <p>This method adds a new entry to the hash, and returns whether the entry was added. Entries are by default always added unless <b><code>QuickHashIntStringHash::CHECK_FOR_DUPES</code></b> has been passed when the hash was created.</p>
		 * @param int $key <p>The key of the entry to add.</p>
		...
		/**
		 * This method returns a serialized version of the hash
		 * <p>This method returns a serialized version of the hash in the same format that <code>QuickHashIntStringHash::loadFromString()</code> can read.</p>
		 * @return string <p>This method returns a string containing a serialized format of the hash. Each element is stored as a four byte value in the Endianness that the current system uses.</p>
	...
	/**
	 * <p>This class wraps around a hash containing strings, where the values are integer numbers. Hashes are also available as implementation of the <code>ArrayAccess</code> interface.</p>
	 * <p>Hashes can also be iterated over with <code>foreach</code> as the <code>Iterator</code> interface is implemented as well. The order of which elements are returned in is not guaranteed.</p>
	...
	class QuickHashStringIntHash {
		...
		/**
		 * @var int <p>If enabled, adding duplicate elements to a set (through either <code>QuickHashStringIntHash::add()</code> or <code>QuickHashStringIntHash::loadFromFile()</code>) will result in those elements to be dropped from the set. This will take up extra time, so only used when it is required.</p>
		 * @link https://php.net/manual/en/class.quickhashstringinthash.php
		 */
		const CHECK_FOR_DUPES = 1;
		 ...
		 * <p>This constructor creates a new <code>QuickHashStringIntHash</code>. The size is the amount of bucket lists to create. The more lists there are, the less collisions you will have. Options are also supported.</p>
		 * @param int $size <p>The amount of bucket lists to configure. The number you pass in will be automatically rounded up to the next power of two. It is also automatically limited from <code>64</code> to <code>4194304</code>.</p>
		 * @param int $options <p>The options that you can pass in are: <b><code>QuickHashStringIntHash::CHECK_FOR_DUPES</code></b>, which makes sure no duplicate entries are added to the hash and <b><code>QuickHashStringIntHash::DO_NOT_USE_ZEND_ALLOC</code></b> to not use PHP's internal memory manager.</p>
		 * @return self <p>Returns a new <code>QuickHashStringIntHash</code> object.</p>
		...
		/**
		 * This method adds a new entry to the hash
		 * <p>This method adds a new entry to the hash, and returns whether the entry was added. Entries are by default always added unless <b><code>QuickHashStringIntHash::CHECK_FOR_DUPES</code></b> has been passed when the hash was created.</p>
		 ...
		 * This method retrieves a value from the hash by its key
		 * <p>This method retrieves a value from the hash by its key.</p>
		 * @param string $key <p>The key of the entry to retrieve.</p>
		 * @return mixed <p>The value if the key exists, or <b><code>null</code></b> if the key wasn't part of the hash.</p>
		...
		/**
		 * This method returns a serialized version of the hash
		 * <p>This method returns a serialized version of the hash in the same format that <code>QuickHashStringIntHash::loadFromString()</code> can read.</p>
		 * @return string <p>This method returns a serialized format of an existing hash, in the same format that <code>QuickHashStringIntHash::loadFromString()</code> can read.</p>
		 ...
		 * @param string $key <p>The key of the entry to update.</p>
