...
namespace {
	...
	/**
	 * <p><b>ArithmeticError</b> is thrown when an error occurs while performing mathematical operations. These errors include attempting to perform a bitshift by a negative amount, and any call to <code>intdiv()</code> that would result in a value outside the possible bounds of an <code>int</code>.</p>
