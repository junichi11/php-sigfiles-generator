...
namespace {
	 ...
	 * @return int <p>Returns the connection status bitfield, which can be used against the <i>CONNECTION_XXX</i> constants to determine the connection status.</p>
	 ...
	 * @param string $name <p>The name of the constant.</p>
	 * @param mixed $value <p>The value of the constant. In PHP 5, <code>value</code> must be a scalar value (<code>integer</code>, <code>float</code>, <code>string</code>, <code>boolean</code>, or <b><code>NULL</code></b>). In PHP 7, <code>array</code> values are also accepted.</p> <p><b>Warning</b></p> <p>While it is possible to define <code>resource</code> constants, it is not recommended and may cause unpredictable behavior.</p>
	 * @param bool $case_insensitive <p>If set to <b><code>TRUE</code></b>, the constant will be defined case-insensitive. The default behavior is case-sensitive; i.e. <i>CONSTANT</i> and <i>Constant</i> represent different values.</p> <p><b>Note</b>:</p><p>Case-insensitive constants are stored as lower-case.</p>
	 ...
	 * @link http://php.net/manual/en/function.hrtime.php
	 * @since PHP 7 >= 7.3.0
	 */
	 ...
	 * <p>Performs a syntax (lint) check on the specified <code>filename</code> testing for scripting errors.</p><p>This is similar to using <b>php -l</b> from the commandline except that this function will execute (but not output) the checked <code>filename</code>.</p><p>For example, if a function is defined in <code>filename</code>, this defined function will be available to the file that executed <b>php_check_syntax()</b>, but output from <code>filename</code> will be suppressed.</p><p><b>Note</b>:</p><p>For technical reasons, this function is deprecated and removed from PHP. Instead, use <i>php -l somefile.php</i> from the commandline.</p>
	 * @param string $filename <p>The name of the file being checked.</p>
	 * @param string $error_message <p>If the <code>error_message</code> parameter is used, it will contain the error message generated by the syntax check. <code>error_message</code> is passed by reference.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> if the lint check passed, and <b><code>FALSE</code></b> if the link check failed or if <code>filename</code> cannot be opened.</p>
	 * @link http://php.net/manual/en/function.php-check-syntax.php
	 ...
	 * @link http://php.net/manual/en/function.sapi-windows-cp-conv.php
	 ...
	 * @link http://php.net/manual/en/function.sapi-windows-cp-get.php
	 ...
	 * @link http://php.net/manual/en/function.sapi-windows-cp-is-utf8.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 * @link http://php.net/manual/en/function.sapi-windows-cp-set.php
	 * @see sapi_windows_cp_get()
	 * @since PHP 7 >= 7.1.0
	 */
	 ...
	 * @link http://php.net/manual/en/function.sapi-windows-vt100-support.php
	 * @since PHP 7 >= 7.2.0
	 */
	 ...
	 * @return int <p>Returns zero on success, or <b><code>FALSE</code></b> on error.</p><p>If the call was interrupted by a signal, <b>sleep()</b> returns a non-zero value. On Windows, this value will always be <i>192</i> (the value of the <b><code>WAIT_IO_COMPLETION</code></b> constant within the Windows API). On other platforms, the return value will be the number of seconds left to sleep.</p>
	 ...
	 * @param int $nanoseconds <p>Must be a non-negative integer less than 1 billion.</p>
	 * @return mixed <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p><p>If the delay was interrupted by a signal, an associative array will be returned with the components:</p><ul> <li>  <i>seconds</i> - number of seconds remaining in the delay  </li> <li>  <i>nanoseconds</i> - number of nanoseconds remaining in the delay  </li> </ul>
	 ...
	 * @return array <p>Returns an associative array containing unpacked elements of binary string.</p>
	 ...
	 * @param int $micro_seconds <p>Halt time in microseconds. A microsecond is one millionth of a second.</p>
...
namespace HRTime {
	...
	/**
	 * @link http://php.net/manual/en/class.hrtime-performancecounter.php
	...
	class PerformanceCounter {
		 ...
		 * @link http://php.net/manual/en/hrtime-performancecounter.getfrequency.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link http://php.net/manual/en/hrtime-performancecounter.getticks.php
		 ...
		 * @return int <p>Returns <code>integer</code> indicating the ticks count.</p>
		 * @link http://php.net/manual/en/hrtime-performancecounter.gettickssince.php
		 * @since PECL hrtime >= 0.6.0
		 */
	...
	/**
	 * @link http://php.net/manual/en/class.hrtime-stopwatch.php
	 * @since PECL hrtime >= 0.4.3
	 */
	class StopWatch extends \HRTime\PerformanceCounter {
		 ...
		 * @link http://php.net/manual/en/hrtime-stopwatch.getelapsedticks.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link http://php.net/manual/en/hrtime-stopwatch.getelapsedtime.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @return int <p>Returns <code>integer</code> indicating elapsed ticks.</p>
		 * @link http://php.net/manual/en/hrtime-stopwatch.getlastelapsedticks.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @param int $unit <p>Time unit represented by a HRTime\Unit constant. Default is HRTime\Unit::SECOND.</p>
		 * @return float <p>Returns <code>float</code> indicating elapsed time.</p>
		 * @link http://php.net/manual/en/hrtime-stopwatch.getlastelapsedtime.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link http://php.net/manual/en/hrtime-stopwatch.isrunning.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @link http://php.net/manual/en/hrtime-stopwatch.start.php
		 * @since PECL hrtime >= 0.4.3
		 */
		 ...
		 * @return void <p>Returns void.</p>
		 * @link http://php.net/manual/en/hrtime-stopwatch.stop.php
		 * @since PECL hrtime >= 0.4.3
		 */
	...
	/**
	 * @link http://php.net/manual/en/class.hrtime-unit.php
	 * @since PECL hrtime >= 0.4.3
	 */
	class Unit {
