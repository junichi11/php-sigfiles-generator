...
namespace {
	...
	/**
	 * @link http://php.net/manual/en/class.weakmap.php
	...
	class WeakMap implements \Countable, \ArrayAccess, \Iterator {
		 ...
		 * @link http://php.net/manual/en/weakmap.construct.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakmap.count.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakmap.current.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakmap.key.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakmap.offsetexists.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakmap.offsetget.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @return void <p>No value is returned.</p>
		 * @link http://php.net/manual/en/weakmap.offsetset.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @return void <p>No value is returned.</p>
		 * @link http://php.net/manual/en/weakmap.offsetunset.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @return void <p>No value is returned.</p>
		 * @link http://php.net/manual/en/weakmap.rewind.php
		 * @since PECL weakref >= 0.2.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakmap.valid.php
		 * @since PECL weakref >= 0.2.0
		 */
	...
	class WeakRef {
		 ...
		 * @return self <p>No value is returned.</p>
		 * @link http://php.net/manual/en/weakref.construct.php
		 * @since PECL weakref >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakref.acquire.php
		 * @since PECL weakref >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakref.get.php
		 * @since PECL weakref >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakref.release.php
		 * @since PECL weakref >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/weakref.valid.php
		 * @since PECL weakref >= 0.1.0
		 */
		public function valid(): bool {}
	}
