...
namespace {
	 ...
	 * @param ?string $options <p>If provided, the <code>options</code> will also be written to the <code>folder</code></p>
	 ...
	 * <p>Marks messages listed in <code>message_nums</code> for deletion. Messages marked for deletion will stay in the mailbox until either <code>imap_expunge()</code> is called or <code>imap_close()</code> is called with the optional parameter <b><code>CL_EXPUNGE</code></b>.</p>
	 * @param \IMAP\Connection $imap <p>An <code>IMAP\Connection</code> instance.</p>
	 * @param string $message_nums <p>A <code>string</code> representing one or more messages in IMAP4-style sequence format (<code>"n"</code>, <code>"n:m"</code>, or combination of these delimited by commas).</p>
	 * @param int $flags <p>You can set the <b><code>FT_UID</code></b> which tells the function to treat the <code>message_nums</code> argument as a <code>UID</code>.</p>
	 ...
	 * @param ?string $return_path <p>Use this parameter to specify return path upon mail delivery failure. This is useful when using PHP as a mail client for multiple users.</p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * @return IMAP\Connection|false <p>Returns an <code>IMAP\Connection</code> instance on success, or <b><code>false</code></b> on failure.</p>
...
namespace IMAP {
	...
	/**
	 * <p>A fully opaque class which replaces a <code>imap</code> resource as of PHP 8.1.0.</p>
	 * @link https://php.net/manual/en/class.imap-connection.php
	 * @since PHP 8 >= 8.1.0
	 */
