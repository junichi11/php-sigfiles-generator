...
namespace {
	 ...
	 * @return array|false <p>Returns an array of all of the IMAP alert messages generated or <b><code>false</code></b> if no alert messages are available.</p>
	 ...
	 * <p>Appends a string <code>message</code> to the specified <code>folder</code>.</p>
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param string $folder <p>The mailbox name, see <code>imap_open()</code> for more information</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 ...
	 * @param string|null $options <p>If provided, the <code>options</code> will also be written to the <code>folder</code></p>
	 * @param string|null $internal_date <p>If this parameter is set, it will set the INTERNALDATE on the appended message. The parameter should be a date string that conforms to the rfc2060 specifications for a date_time value.</p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.imap-append.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	function imap_append($imap, string $folder, string $message, string|null $options = null, string|null $internal_date = null): bool {}

	/**
	 * Decode BASE64 encoded text
	 * <p>Decodes the given BASE-64 encoded <code>string</code>.</p>
	 * @param string $string <p>The encoded text</p>
	 * @return string|false <p>Returns the decoded message as a string, or <b><code>false</code></b> on failure.</p>
	 ...
	 * <p><b>imap_body()</b> returns the body of the message, numbered <code>message_num</code> in the current mailbox.</p><p><b>imap_body()</b> will only return a verbatim copy of the message body. To extract single parts of a multipart MIME-encoded message you have to use <code>imap_fetchstructure()</code> to analyze its structure and <code>imap_fetchbody()</code> to extract a copy of a single body component.</p>
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param int $message_num <p>The message number</p>
	 * @param int $flags <p>The optional <code>flags</code> are a bit mask with one or more of the following:</p><ul> <li>  <b><code>FT_UID</code></b> - The <code>message_num</code> is a UID  </li> <li>  <b><code>FT_PEEK</code></b> - Do not set the \Seen flag if not already set  </li> <li>  <b><code>FT_INTERNAL</code></b> - The return string is in internal format, will not canonicalize to CRLF.  </li> </ul>
	 * @return string|false <p>Returns the body of the specified message, as a string, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @return stdClass|false <p>Returns the information in an object, or <b><code>false</code></b> on failure. For a detailed description of the object structure and properties see <code>imap_fetchstructure()</code>.</p>
	 * @link https://php.net/manual/en/function.imap-bodystruct.php
	 * @see imap_fetchstructure()
	 * @since PHP 4, PHP 5, PHP 7
	 */
	function imap_bodystruct($imap, int $message_num, string $section): \stdClass|false {}
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param int $flags <p>If set to <b><code>CL_EXPUNGE</code></b>, the function will silently expunge the mailbox before closing, removing all messages marked for deletion. You can achieve the same thing by using <code>imap_expunge()</code></p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * <p>Marks messages listed in <code>message_num</code> for deletion. Messages marked for deletion will stay in the mailbox until either <code>imap_expunge()</code> is called or <code>imap_close()</code> is called with the optional parameter <b><code>CL_EXPUNGE</code></b>.</p>
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param string $message_num <p>The message number</p>
	 * @param int $flags <p>You can set the <b><code>FT_UID</code></b> which tells the function to treat the <code>message_num</code> argument as a <code>UID</code>.</p>
	 ...
	 * @return array|false <p>This function returns an array of all of the IMAP error messages generated since the last <b>imap_errors()</b> call, or the beginning of the page. Returns <b><code>false</code></b> if no error messages are available.</p>
	 ...
	 * @param int $flags <p>A bitmask with one or more of the following:</p><ul> <li>  <b><code>FT_UID</code></b> - The <code>message_num</code> is a UID  </li> <li>  <b><code>FT_PEEK</code></b> - Do not set the \Seen flag if not already set  </li> <li>  <b><code>FT_INTERNAL</code></b> - The return string is in internal format, will not canonicalize to CRLF.  </li> </ul>
	 * @return string|false <p>Returns a particular section of the body of the specified messages as a text string, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @return string|false <p>Returns the header of the specified message as a text string, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param string $section <p>The part number. It is a string of integers delimited by period which index into a body part list as per the IMAP4 specification</p>
	 * @param int $flags <p>A bitmask with one or more of the following:</p><ul> <li>  <b><code>FT_UID</code></b> - The <code>message_num</code> is a UID  </li> <li>  <b><code>FT_PEEK</code></b> - Do not set the \Seen flag if not already set  </li> <li>  <b><code>FT_INTERNAL</code></b> - The return string is in internal format, will not canonicalize to CRLF.  </li> </ul>
	 * @return string|false <p>Returns the MIME headers of a particular section of the body of the specified messages as a text string, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param int $flags <p>The optional <code>flags</code> are a bit mask with one or more of the following:</p><ul> <li>  <b><code>FT_UID</code></b> - The <code>message_num</code> is a UID  </li> <li>  <b><code>FT_PEEK</code></b> - Do not set the \Seen flag if not already set  </li> <li>  <b><code>FT_INTERNAL</code></b> - The return string is in internal format, will not canonicalize to CRLF.  </li> </ul>
	 * @return string|false
	 * @link https://php.net/manual/en/function.imap-fetchtext.php
	 * @since PHP 4, PHP 5, PHP 7
	 */
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param int $flags <p>Specifies the cache to purge. It may one or a combination of the following constants: <b><code>IMAP_GC_ELT</code></b> (message cache elements), <b><code>IMAP_GC_ENV</code></b> (envelope and bodies), <b><code>IMAP_GC_TEXTS</code></b> (texts).</p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param string $mailbox <p>The mailbox name, see <code>imap_open()</code> for more information</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 * @return array|false <p>Returns an associative array of "folder" =&gt; "acl" pairs, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param string $reference <p><code>reference</code> should normally be just the server specification as described in <code>imap_open()</code></p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param int $message_num <p>The message number</p>
	 * @param int $from_length <p>Number of characters for the <code>fetchfrom</code> property. Must be greater than or equal to zero.</p>
	 * @param int $subject_length <p>Number of characters for the <code>fetchsubject</code> property Must be greater than or equal to zero.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @return array|false <p>Returns an array of string formatted with header info. One element per mail message. Returns <b><code>false</code></b> on failure.</p>
	 ...
	 * @return string|false <p>Returns the full text of the last IMAP error message that occurred on the current page. Returns <b><code>false</code></b> if no error messages are available.</p>
	 ...
	 * @param string $reference <p><code>reference</code> should normally be just the server specification as described in <code>imap_open()</code>.</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 * @param string $pattern <p>Specifies where in the mailbox hierarchy to start searching.</p><p>There are two special characters you can pass as part of the <code>pattern</code>: '<code>&#42;</code>' and '<code>%</code>'. '<code>&#42;</code>' means to return all mailboxes. If you pass <code>pattern</code> as '<code>&#42;</code>', you will get a list of the entire mailbox hierarchy. '<code>%</code>' means to return the current level only. '<code>%</code>' as the <code>pattern</code> parameter will return only the top level mailboxes; '<code>~/mail/%</code>' on <code>UW_IMAPD</code> will return every mailbox in the ~/mail directory, but none in subfolders of that directory.</p>
	 * @return array|false <p>Returns an array containing the names of the mailboxes or <b><code>false</code></b> in case of failure.</p>
	 ...
	 * @return array|false <p>Returns an array containing the names of the mailboxes that have <code>content</code> in the text of the mailbox, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param string $reference <p><code>reference</code> should normally be just the server specification as described in <code>imap_open()</code></p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 * @param string $pattern <p>Specifies where in the mailbox hierarchy to start searching.</p><p>There are two special characters you can pass as part of the <code>pattern</code>: '<code>&#42;</code>' and '<code>%</code>'. '<code>&#42;</code>' means to return all mailboxes. If you pass <code>pattern</code> as '<code>&#42;</code>', you will get a list of the entire mailbox hierarchy. '<code>%</code>' means to return the current level only. '<code>%</code>' as the <code>pattern</code> parameter will return only the top level mailboxes; '<code>~/mail/%</code>' on <code>UW_IMAPD</code> will return every mailbox in the ~/mail directory, but none in subfolders of that directory.</p>
	 * @return array|false <p>Returns an array of all the subscribed mailboxes, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param string|null $additional_headers <p>As string with additional headers to be set on the mail</p>
	 * @param string|null $cc
	 * @param string|null $bcc <p>The receivers specified in <code>bcc</code> will get the mail, but are excluded from the headers.</p>
	 * @param string|null $return_path <p>Use this parameter to specify return path upon mail delivery failure. This is useful when using PHP as a mail client for multiple users.</p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * <p>Create a MIME message based on the given <code>envelope</code> and <code>bodies</code> sections.</p>
	 ...
	 * @param string $mailbox <p>The mailbox name, see <code>imap_open()</code> for more information</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 * @param int $flags <p><code>flags</code> is a bitmask of one or more of</p><ul> <li>  <b><code>CP_UID</code></b> - the sequence numbers contain UIDS  </li> <li>  <b><code>CP_MOVE</code></b> - Delete the messages from the current mailbox after copying  </li> </ul>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * <p>Moves mail messages specified by <code>message_nums</code> to the specified <code>mailbox</code>.</p>
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param string $message_nums <p><code>message_nums</code> is a range not just message numbers (as described in RFC2060).</p>
	 * @param string $mailbox <p>The mailbox name, see <code>imap_open()</code> for more information</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 ...
	 * <p>Returns the message sequence number for the given <code>message_uid</code>.</p><p>This function is the inverse of <code>imap_uid()</code>.</p>
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param int $message_uid <p>The message UID</p>
	 * @return int <p>Returns the message sequence number for the given <code>message_uid</code>.</p>
	 ...
	 * @param string $string <p>A string encoded in modified UTF-7.</p>
	 * @return string|false <p>Returns <code>string</code> converted to UTF-8, or <b><code>false</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.imap-mutf7-to-utf8.php
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @return int|false <p>Return the number of messages in the current mailbox, as an integer, or <b><code>false</code></b> on error.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param string $from <p>The old mailbox name, see <code>imap_open()</code> for more information</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 * @param string $to <p>The new mailbox name, see <code>imap_open()</code> for more information</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 * @return bool
	 ...
	 * @param string $default_hostname <p>The default host name</p>
	 * @return stdClass <p>Returns an object similar to the one returned by <code>imap_header()</code>, except for the flags and other properties that come from the IMAP server.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param resource|string|int $file <p>The path to the saved file as a string, or a valid file descriptor returned by <code>fopen()</code>.</p>
	 * @param int $message_num <p>The message number</p>
	 * @param string $section <p>The part number. It is a string of integers delimited by period which index into a body part list as per the IMAP4 specification</p>
	 * @param int $flags <p>A bitmask with one or more of the following:</p><ul> <li>  <b><code>FT_UID</code></b> - The <code>message_num</code> is a UID  </li> <li>  <b><code>FT_PEEK</code></b> - Do not set the \Seen flag if not already set  </li> <li>  <b><code>FT_INTERNAL</code></b> - The return string is in internal format, will not canonicalize to CRLF.  </li> </ul>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * @return array|false <p>Returns an array of message numbers or UIDs.</p><p>Return <b><code>false</code></b> if it does not understand the search <code>criteria</code> or no messages have been found.</p>
	 ...
	 * @param int $mailbox_size <p>The maximum size (in KB) for the <code>quota_root</code></p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param string $mailbox <p>The mailbox name, see <code>imap_open()</code> for more information</p> <p><b>Warning</b></p><p>Passing untrusted data to this parameter is <i>insecure</i>, unless imap.enable_insecure_rsh is disabled.</p>
	 * @param string $user_id <p>The user to give the rights to.</p>
	 ...
	 * @param bool $reverse <p>Whether to sort in reverse order.</p>
	 * @param int $flags <p>The <code>flags</code> are a bitmask of one or more of the following:</p><ul> <li>  <b><code>SE_UID</code></b> - Return UIDs instead of sequence numbers  </li> <li>  <b><code>SE_NOPREFETCH</code></b> - Don't prefetch searched messages  </li> </ul>
	 * @param string|null $search_criteria <p>IMAP2-format search criteria string. For details see <code>imap_search()</code>.</p>
	 * @param string|null $charset <p>MIME character set to use when sorting strings.</p>
	 ...
	 * @since PHP 4, PHP 5, PHP 7
	 */
	function imap_sort($imap, int $criteria, bool $reverse, int $flags = 0, string|null $search_criteria = null, string|null $charset = null): array|false {}
	 ...
	 * @return int|bool <p>If the <code>timeout</code> parameter is set, this function returns <b><code>true</code></b> on success and <b><code>false</code></b> on failure.</p><p>If <code>timeout</code> is not provided or evaluates to -1, the current timeout value of <code>timeout_type</code> is returned as an integer.</p>
	 ...
	 * @param resource $imap <p>An IMAP stream returned by <code>imap_open()</code>.</p>
	 * @param int $message_num <p>The message number.</p>
	 * @return int|false <p>The UID of the given message.</p>
	 ...
	 * @return string|false <p>Returns <code>string</code> converted to modified UTF-7, or <b><code>false</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.imap-utf8-to-mutf7.php
