...
namespace {
	 ...
	 * <p>As of PHP 8.1.0, a class which implements <b>Serializable</b> without also implementing __serialize() and __unserialize() will generate a deprecation warning.</p>
	...
	interface Serializable {
		 ...
		 * @param string $data <p>The string representation of the object.</p>
