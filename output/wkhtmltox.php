...
namespace wkhtmltox\Image {
	 ...
	 * @link http://php.net/manual/en/class.wkhtmltox-image-converter.php
	...
	class Converter {
		 ...
		 * @return self
		 * @link http://php.net/manual/en/wkhtmltox-image-converter.construct.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/wkhtmltox-image-converter.convert.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/wkhtmltox-image-converter.getversion.php
...
namespace wkhtmltox\PDF {
	 ...
	 * @link http://php.net/manual/en/class.wkhtmltox-pdf-converter.php
	 * @since wkhtmltox >= 0.1.0
	 */
	class Converter {
		 ...
		 * @return self
		 * @link http://php.net/manual/en/wkhtmltox-pdf-converter.construct.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @return void
		 * @link http://php.net/manual/en/wkhtmltox-pdf-converter.add.php
		 * @since wkhtmltox >= 0.1.0
		 */
		 ...
		 * @return ?string <p>Where the return value is used, it will be populated with the contents of the conversion buffer</p>
		 * @link http://php.net/manual/en/wkhtmltox-pdf-converter.convert.php
		 * @since wkhtmltox >= 0.1.0
		 */
		public function convert(): ?string {}
		 ...
		 * @link http://php.net/manual/en/wkhtmltox-pdf-converter.getversion.php
		 * @since wkhtmltox >= 0.3.2
		 */
		public function getVersion(): string {}
	}
	 ...
	 * @link http://php.net/manual/en/class.wkhtmltox-pdf-object.php
	 * @since wkhtmltox >= 0.1.0
	 */
	class Object {
		 ...
		 * @return self
		 * @link http://php.net/manual/en/wkhtmltox-pdf-object.construct.php
		 * @since wkhtmltox >= 0.1.0
		 */
