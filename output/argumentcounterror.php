...
namespace {
	...
	/**
	 * <p><b>ArgumentCountError</b> is thrown when too few arguments are passed to a user-defined function or method.</p>
	 * @link https://php.net/manual/en/class.argumentcounterror.php
	 * @since PHP 7 >= PHP 7.1.0, PHP 8
	 */
