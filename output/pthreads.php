...
namespace {
	...
	class Pool {
		 ...
		 * @link http://php.net/manual/en/class.pool.php#pool.props.size
		 */
		protected $size;

		/**
		 * @var mixed <p>the class of the Worker</p>
		 * @link http://php.net/manual/en/class.pool.php#pool.props.class
		 */
		protected $class;

		/**
		 * @var mixed <p>references to Workers</p>
		 * @link http://php.net/manual/en/class.pool.php#pool.props.workers
		 */
		protected $workers;

		/**
		 * @var mixed <p>the arguments for constructor of new Workers</p>
		 * @link http://php.net/manual/en/class.pool.php#pool.props.ctor
		 */
		protected $ctor;

		/**
		 * @var mixed <p>offset in workers of the last Worker used</p>
		 * @link http://php.net/manual/en/class.pool.php#pool.props.last
		 */
		protected $last;
	...
	class Thread extends \Threaded implements \Countable, \Traversable, \ArrayAccess {
		 ...
		 * @link http://php.net/manual/en/thread.isrunning.php
		 * @since PECL pthreads >= 2.0.0
		 */
