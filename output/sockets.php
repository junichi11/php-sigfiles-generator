...
namespace {
	 ...
	 * <p>After the socket <code>socket</code> has been created using <code>socket_create()</code>, bound to a name with <code>socket_bind()</code>, and told to listen for connections with <code>socket_listen()</code>, this function will accept incoming connections on that socket. Once a successful connection is made, a new Socket instance is returned, which may be used for communication. If there are multiple connections queued on the socket, the first will be used. If there are no pending connections, <b>socket_accept()</b> will block until a connection becomes present. If <code>socket</code> has been made non-blocking using <code>socket_set_blocking()</code> or <code>socket_set_nonblock()</code>, <b><code>false</code></b> will be returned.</p><p>The Socket instance returned by <b>socket_accept()</b> may not be used to accept new connections. The original listening socket <code>socket</code>, however, remains open and may be reused.</p>
	 * @param \Socket $socket <p>A Socket instance created with <code>socket_create()</code>.</p>
	 * @return Socket|false <p>Returns a new Socket instance on success, or <b><code>false</code></b> on error. The actual error code can be retrieved by calling <code>socket_last_error()</code>. This error code may be passed to <code>socket_strerror()</code> to get a textual explanation of the error.</p>
	 ...
	 * <p>Create a Socket instance, and bind it to the provided AddressInfo. The return value of this function may be used with <code>socket_listen()</code>.</p>
	 * @param \AddressInfo $address <p>AddressInfo instance created from <code>socket_addrinfo_lookup()</code>.</p>
	 * @return Socket|false <p>Returns a Socket instance on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * <p>Create a Socket instance, and connect it to the provided AddressInfo instance. The return value of this function may be used with the rest of the socket functions.</p>
	 * @param \AddressInfo $address <p>AddressInfo instance created from <code>socket_addrinfo_lookup()</code></p>
	 * @return Socket|false <p>Returns a Socket instance on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * <p>Lookup different ways we can connect to <code>host</code>. The returned array contains a set of AddressInfo instances that we can bind to using <code>socket_addrinfo_bind()</code>.</p>
	 * @param string $host <p>Hostname to search.</p>
	 * @param string|null $service <p>The service to connect to. If service is a name, it is translated to the corresponding port number.</p>
	 ...
	 * @return array|false <p>Returns an array of AddressInfo instances that can be used with the other socket_addrinfo functions. On failure, <b><code>false</code></b> is returned.</p>
	 ...
	 * @since PHP 7 >= 7.2.0
	 */
	function socket_addrinfo_lookup(string $host, string|null $service = null, array $hints = []): array|false {}
	 ...
	 * @param \Socket|null $socket <p>A Socket instance created with <code>socket_create()</code>.</p>
	 ...
	 * <p><b>socket_close()</b> closes the Socket instance given by <code>socket</code>.</p>
	 * @param \Socket $socket <p>A Socket instance created with <code>socket_create()</code> or <code>socket_accept()</code>.</p>
	 * @return void <p>No value is returned.</p>
	 ...
	 * <p>Initiate a connection to <code>address</code> using the Socket instance <code>socket</code>, which must be Socket instance created with <code>socket_create()</code>.</p>
	 * @param \Socket $socket
	 ...
	 * @param int|null $port <p>The <code>port</code> parameter is only used and is mandatory when connecting to an <b><code>AF_INET</code></b> or an <b><code>AF_INET6</code></b> socket, and designates the port on the remote host to which a connection should be made.</p>
	 ...
	 * <p>Creates and returns a Socket instance, also referred to as an endpoint of communication. A typical network connection is made up of 2 sockets, one performing the role of the client, and another performing the role of the server.</p>
	 ...
	 * @return Socket|false <p><b>socket_create()</b> returns a Socket instance on success, or <b><code>false</code></b> on error. The actual error code can be retrieved by calling <code>socket_last_error()</code>. This error code may be passed to <code>socket_strerror()</code> to get a textual explanation of the error.</p>
	 ...
	 * <p><b>socket_create_listen()</b> creates a new Socket instance of type <b><code>AF_INET</code></b> listening on <i>all</i> local interfaces on the given port waiting for new connections.</p><p>This function is meant to ease the task of creating a new socket which only listens to accept new connections.</p>
	 ...
	 * @return Socket|false <p><b>socket_create_listen()</b> returns a new Socket instance on success or <b><code>false</code></b> on error. The error code can be retrieved with <code>socket_last_error()</code>. This code may be passed to <code>socket_strerror()</code> to get a textual explanation of the error.</p>
	 ...
	 * @param array $pair <p>Reference to an array in which the two Socket instances will be inserted.</p>
	 ...
	 * @param \Socket $socket <p>A Socket instance created with <code>socket_create()</code> or <code>socket_addrinfo_bind()</code></p>
	 ...
	 * <p>The function <b>socket_read()</b> reads from the Socket instance <code>socket</code> created by the <code>socket_create()</code> or <code>socket_accept()</code> functions.</p>
	 * @param \Socket $socket <p>A Socket instance created with <code>socket_create()</code> or <code>socket_accept()</code>.</p>
	 ...
	 * @param \Socket $socket <p>The <code>socket</code> must be a Socket instance previously created by socket_create().</p>
	 * @param string|null $data <p>The data received will be fetched to the variable specified with <code>data</code>. If an error occurs, if the connection is reset, or if no data is available, <code>data</code> will be set to <b><code>null</code></b>.</p>
	 ...
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	function socket_recv(\Socket $socket, string|null &$data, int $length, int $flags): int|false {}
	 ...
	 * @since PHP 4 >= 4.1.0, PHP 5, PHP 7
	 */
	function socket_select(array|null &$read, array|null &$write, array|null &$except, int|null $seconds, int $microseconds = 0): int|false {}
	 ...
	 * @param \Socket $socket <p>A Socket instance created using <code>socket_create()</code>.</p>
	 ...
	 * @param int|null $port <p><code>port</code> is the remote port number at which the data will be sent.</p>
	 ...
	 * @param int|null $length <p>The optional parameter <code>length</code> can specify an alternate length of bytes written to the socket. If this length is greater than the buffer length, it is silently truncated to the length of the buffer.</p>
	 ...
	 * @param \Socket $socket <p>A Socket instance.</p>
