...
namespace {
	 ...
	 * @param array $siginfo <p>The <code>siginfo</code> is set to an array containing information about the signal. See <code>pcntl_sigwaitinfo()</code>.</p>
	 ...
	 * <p></p><p>This function is currently not documented; only its argument list is available.</p>
	 * @param int $errno
	 * @return string|false <p>Returns error description on success or <b><code>FALSE</code></b> on failure.</p>
	 ...
	 * @param int $pid <p>The value of <code>pid</code> can be one of the following:</p> <b>possible values for <code>pid</code></b>   <code>&lt; -1</code>  wait for any child process whose process group ID is equal to the absolute value of <code>pid</code>.    <code>-1</code>  wait for any child process; this is the same behaviour that the wait function exhibits.    <code>0</code>  wait for any child process whose process group ID is equal to that of the calling process.    <code>&gt; 0</code>  wait for the child whose process ID is equal to the value of <code>pid</code>.     <p><b>Note</b>:</p><p>Specifying <code>-1</code> as the <code>pid</code> is equivalent to the functionality <code>pcntl_wait()</code> provides (minus <code>options</code>).</p>
	 * @param int $status <p><b>pcntl_waitpid()</b> will store status information in the <code>status</code> parameter which can be evaluated using the following functions: <code>pcntl_wifexited()</code>, <code>pcntl_wifstopped()</code>, <code>pcntl_wifsignaled()</code>, <code>pcntl_wexitstatus()</code>, <code>pcntl_wtermsig()</code> and <code>pcntl_wstopsig()</code>.</p>
	 * @param int $options <p>The value of <code>options</code> is the value of zero or more of the following two global constants <code>OR</code>'ed together:</p> <b>possible values for <code>options</code></b>   <code>WNOHANG</code>  return immediately if no child has exited.    <code>WUNTRACED</code>  return for children which are stopped, and whose status has not been reported.
	 * @param array $rusage
