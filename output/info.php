...
namespace {
	 ...
	 * @return string|null <p>Return a string with the current process title or <b><code>null</code></b> on error.</p>
	 ...
	 * @param string $value <p>The new value for the option.</p>
	 * @return string|false
