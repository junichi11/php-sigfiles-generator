...
namespace {
	 ...
	 * @link https://php.net/manual/en/function.dbase-add-record.php
	 ...
	 * @param resource $database <p>The database resource, returned by <code>dbase_open()</code> or <code>dbase_create()</code>.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.dbase-close.php
	 ...
	 * @link https://php.net/manual/en/function.dbase-create.php
	 ...
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.dbase-delete-record.php
	 ...
	 * @link https://php.net/manual/en/function.dbase-get-header-info.php
	 * @since PHP 5 < 5.3.0, dbase 5, dbase 7
	 */
	 ...
	 * @link https://php.net/manual/en/function.dbase-get-record.php
	 ...
	 * @link https://php.net/manual/en/function.dbase-get-record-with-names.php
	 ...
	 * @link https://php.net/manual/en/function.dbase-numfields.php
	 ...
	 * @link https://php.net/manual/en/function.dbase-numrecords.php
	 * @see dbase_numfields()
	 * @since PHP 5 < 5.3.0, dbase 5, dbase 7
	 */
	 ...
	 * @link https://php.net/manual/en/function.dbase-open.php
	 ...
	 * @param resource $database <p>The database resource, returned by <code>dbase_open()</code> or <code>dbase_create()</code>.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.dbase-pack.php
	 ...
	 * @param int $number <p>An integer which spans from 1 to the number of records in the database (as returned by <code>dbase_numrecords()</code>).</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.dbase-replace-record.php
