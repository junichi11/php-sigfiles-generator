...
namespace {
	...
	class OAuth {
		...
		/**
		 * @var mixed
		 * @link http://php.net/manual/en/class.oauth.php#oauth.props.debug
		 */
		public $debug;

		/**
		 * @var mixed
		 * @link http://php.net/manual/en/class.oauth.php#oauth.props.sslchecks
		 */
		public $sslChecks;

		/**
		 * @var mixed
		 * @link http://php.net/manual/en/class.oauth.php#oauth.props.debuginfo
		 */
		public $debugInfo;
	...
	class OAuthException extends \Exception {
		 ...
		 * @link http://php.net/manual/en/class.oauthexception.php#oauthexception.props.lastresponse
		 */
		public $lastResponse;

		/**
		 * @var mixed
		 * @link http://php.net/manual/en/class.oauthexception.php#oauthexception.props.debuginfo
		 */
		public $debugInfo;
