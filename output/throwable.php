...
namespace {
	...
	/**
	 * <p><b>Throwable</b> is the base interface for any object that can be thrown via a <i>throw</i> statement in PHP 7, including Error and Exception.</p>
	 * <p><b>Note</b>:</p>
	...
	interface Throwable {
		 ...
		 * @return int <p>Returns the exception code as <code>integer</code> in Exception but possibly as other type in Exception descendants (for example as <code>string</code> in PDOException).</p>
