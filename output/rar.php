...
namespace {
	 ...
	 * @link http://php.net/manual/en/class.rararchive.php
	...
	final class RarArchive implements \Traversable {
		 ...
		 * @link http://php.net/manual/en/rararchive.tostring.php
		 * @since PECL rar >= 2.0.0
		 */
		 ...
		 * @link http://php.net/manual/en/rararchive.setallowbroken.php
		 * @since PECL rar >= 3.0.0
		 */
	 ...
	 * @return string
	 * @link http://php.net/manual/en/function.rar-wrapper-cache-stats.php
	 * @since PECL rar >= 3.0.0
	 */
