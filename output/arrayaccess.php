...
namespace {
	...
	interface ArrayAccess {
		 ...
		 * <p>Whether or not an offset exists.</p><p>This method is executed when using <code>isset()</code> or <code>empty()</code> on objects implementing <code>ArrayAccess</code>.</p><p><b>Note</b>:</p><p>When using <code>empty()</code> <code>ArrayAccess::offsetGet()</code> will be called and checked if empty only if <b>ArrayAccess::offsetExists()</b> returns <b><code>true</code></b>.</p>
