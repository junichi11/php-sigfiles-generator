...
namespace {
	...
	class SVM {
		 ...
		 * @link http://php.net/manual/en/svm.construct.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/svm.getoptions.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/svm.setoptions.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/svm.train.php
		 * @since PECL svm >= 0.1.0
		 */
	 ...
	 * @link http://php.net/manual/en/class.svmmodel.php
	 * @since PECL svm >= 0.1.0
	 */
	class SVMModel {
		 ...
		 * @link http://php.net/manual/en/svmmodel.construct.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @link http://php.net/manual/en/svmmodel.checkprobabilitymodel.php
		 ...
		 * @link http://php.net/manual/en/svmmodel.getlabels.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link http://php.net/manual/en/svmmodel.getnrclass.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link http://php.net/manual/en/svmmodel.getsvmtype.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link http://php.net/manual/en/svmmodel.getsvrprobability.php
		 * @since PECL svm >= 0.1.5
		 */
		 ...
		 * @link http://php.net/manual/en/svmmodel.load.php
		 ...
		 * @link http://php.net/manual/en/svmmodel.predict.php
		 * @since PECL svm >= 0.1.0
		 */
		 ...
		 * @return bool <p>Throws SVMException on error. Returns true on success.</p>
		 * @link http://php.net/manual/en/svmmodel.save.php
		 * @since PECL svm >= 0.1.0
		 */
