...
namespace {
	 ...
	 * @param string $algo <p>Name of selected hashing algorithm (e.g. "md5", "sha256", "haval160,4", etc..)</p>
	 ...
	 * @return string <p>Returns a string containing the calculated message digest as lowercase hexits unless <code>raw_output</code> is set to true in which case the raw binary representation of the message digest is returned.</p>
	 ...
	 * @param string $algo <p>Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..)</p>
	 ...
	 * @param bool $raw_output <p>When set to <b><code>TRUE</code></b>, outputs raw binary data. <b><code>FALSE</code></b> outputs lowercase hexits.</p>
	 * @return string <p>Returns a string containing the calculated message digest as lowercase hexits unless <code>raw_output</code> is set to true in which case the raw binary representation of the message digest is returned. Returns <b><code>FALSE</code></b> when <code>algo</code> is unknown or is a non-cryptographic hash function.</p>
	 ...
	 * @param string $key <p>Shared secret key used for generating the HMAC variant of the message digest.</p>
	 * @param bool $raw_output <p>When set to <b><code>TRUE</code></b>, outputs raw binary data. <b><code>FALSE</code></b> outputs lowercase hexits.</p>
	 * @return string <p>Returns a string containing the calculated message digest as lowercase hexits unless <code>raw_output</code> is set to true in which case the raw binary representation of the message digest is returned. Returns <b><code>FALSE</code></b> when <code>algo</code> is unknown or is a non-cryptographic hash function, or if the file <code>filename</code> cannot be read.</p>
	 ...
	 * @param int $options <p>Optional settings for hash generation, currently supports only one option: <b><code>HASH_HMAC</code></b>. When specified, the <code>key</code> <i>must</i> be specified.</p>
	 * @param string $key <p>When <b><code>HASH_HMAC</code></b> is specified for <code>options</code>, a shared secret key to be used with the HMAC hashing method must be supplied in this parameter.</p>
	 ...
	 * @param string $algo <p>Name of selected hashing algorithm (i.e. <i>md5</i>, <i>sha256</i>, <i>haval160,4</i>, etc..) See <code>hash_algos()</code> for a list of supported algorithms.</p>
	 ...
	 * @param int $length <p>The length of the output string. If <code>raw_output</code> is <b><code>TRUE</code></b> this corresponds to the byte-length of the derived key, if <code>raw_output</code> is <b><code>FALSE</code></b> this corresponds to twice the byte-length of the derived key (as every byte of the key is returned as two hexits).</p> <p>If <i>0</i> is passed, the entire output of the supplied algorithm is used.</p>
	 * @param bool $raw_output <p>When set to <b><code>TRUE</code></b>, outputs raw binary data. <b><code>FALSE</code></b> outputs lowercase hexits.</p>
	 * @return string <p>Returns a string containing the derived key as lowercase hexits unless <code>raw_output</code> is set to <b><code>TRUE</code></b> in which case the raw binary representation of the derived key is returned.</p>
	 ...
	 * @param \HashContext $hcontext <p>Hashing context returned by <code>hash_init()</code>.</p>
	 * @param string $filename <p>URL describing location of file to be hashed; Supports fopen wrappers.</p>
	 * @param resource $scontext <p>Stream context as returned by <code>stream_context_create()</code>.</p>
	 ...
	 * @param \HashContext $context <p>Hashing context returned by <code>hash_init()</code>.</p>
	 * @param resource $handle <p>Open file handle as returned by any stream creation function.</p>
	 * @param int $length <p>Maximum number of characters to copy from <code>handle</code> into the hashing context.</p>
	 * @return int <p>Actual number of bytes added to the hashing context from <code>handle</code>.</p>
