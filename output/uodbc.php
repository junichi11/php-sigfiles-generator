...
namespace {
	 ...
	 * @param array $params <p>Parameters in <code>params</code> will be substituted for placeholders in the prepared statement in order. Elements of this array will be converted to strings by calling this function.</p> <p>Any parameters in <code>params</code> which start and end with single quotes will be taken as the name of a file to read and send to the database server as the data for the appropriate placeholder.</p>  If you wish to store a string which actually begins and ends with single quotes, you must add a space or other non-single-quote character to the beginning or end of the parameter, which will prevent the parameter from being taken as a file name. If this is not an option, then you must use another mechanism to store the string, such as executing the query directly with <code>odbc_exec()</code>).
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param ?string $catalog <p>The catalog ('qualifier' in ODBC 2 parlance).</p>
	 * @param ?string $schema <p>The schema ('owner' in ODBC 2 parlance). This parameter accepts the following search patterns: <code>%</code> to match zero or more characters, and <code>_</code> to match a single character.</p>
	 * @param ?string $procedure <p>The proc. This parameter accepts the following search patterns: <code>%</code> to match zero or more characters, and <code>_</code> to match a single character.</p>
	 * @param ?string $column <p>The column. This parameter accepts the following search patterns: <code>%</code> to match zero or more characters, and <code>_</code> to match a single character.</p>
	 ...
	 * @param ?string $catalog <p>The catalog ('qualifier' in ODBC 2 parlance).</p>
	 * @param ?string $schema <p>The schema ('owner' in ODBC 2 parlance). This parameter accepts the following search patterns: <code>%</code> to match zero or more characters, and <code>_</code> to match a single character.</p>
	 * @param ?string $procedure <p>The name. This parameter accepts the following search patterns: <code>%</code> to match zero or more characters, and <code>_</code> to match a single character.</p>
