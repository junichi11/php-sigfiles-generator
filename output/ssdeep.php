...
namespace {
	 ...
	 * @link https://php.net/manual/en/function.ssdeep-fuzzy-compare.php
	 ...
	 * @link https://php.net/manual/en/function.ssdeep-fuzzy-hash.php
	 * @since PECL ssdeep >= 1.0.0
	 */
	 ...
	 * @return string <p>Returns a string on success, <b><code>FALSE</code></b> otherwise.</p>
	 * @link https://php.net/manual/en/function.ssdeep-fuzzy-hash-filename.php
	 * @since PECL ssdeep >= 1.0.0
	 */
