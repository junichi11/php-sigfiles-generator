...
');
	 ...
	 */
	define('PHP_EXTRA_VERSION', '-0ubuntu1');
	...
	/**
	 * Smallest representable positive number x, so that <i>x + 1.0 != 1.0</i>. Available as of PHP 7.2.0.
	 */
	...
	/**
	 * The operating system family PHP was built for. Either of <i>'Windows'</i>, <i>'BSD'</i>, <i>'Darwin'</i>, <i>'Solaris'</i>, <i>'Linux'</i> or <i>'Unknown'</i>. Available as of PHP 7.2.0.
	 */
	 ...
	 */
	define('PHP_VERSION', '7.2.10-0ubuntu1');
