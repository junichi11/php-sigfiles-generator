...
namespace {
	 ...
	 * @link http://php.net/manual/en/function.lzf-compress.php
	 * @see lzf_decompress()
	 ...
	 * @link http://php.net/manual/en/function.lzf-decompress.php
	 * @see lzf_compress()
	 * @since PECL lzf >= 0.1.0
	 */
	 ...
	 * @link http://php.net/manual/en/function.lzf-optimized-for.php
