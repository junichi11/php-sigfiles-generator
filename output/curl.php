...
namespace {
	...
	class CURLFile {
		...
		/**
		 * @var mixed <p>MIME type of the file (default is <code>application/octet-stream</code>).</p>
		 ...
		 * @param string|null $posted_filename <p>Name of the file to be used in the upload data.</p>
	 ...
	 * <p>Closes a cURL session and frees all resources. The cURL handle, <code>handle</code>, is also deleted.</p>
	 ...
	 * @param string|null $url <p>If provided, the <b><code>CURLOPT_URL</code></b> option will be set to its value. You can manually set this using the <code>curl_setopt()</code> function.</p> <p><b>Note</b>:</p><p>The <code>file</code> protocol is disabled by cURL if open_basedir is set.</p>
	 ...
	 * @param \CurlHandle $handle <p>A cURL handle returned by <code>curl_init()</code>.</p>
	 * @return string|null <p>Return the content of a cURL handle if <b><code>CURLOPT_RETURNTRANSFER</code></b> is set.</p>
	 ...
	 * @return string|null <p>Returns error string for valid error code, <b><code>NULL</code></b> otherwise.</p>
	 ...
	 * @return string|null <p>Returns error description or <b><code>NULL</code></b> for invalid error code.</p>
