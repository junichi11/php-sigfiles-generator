...
namespace {
	 ...
	 * @param string|null $encoding <p>The expected encoding.</p>
	 * @return bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure.</p>
	 * @link https://php.net/manual/en/function.mb-check-encoding.php
	 * @since PHP 4 >= 4.4.3, PHP 5 >= 5.1.3, PHP 7
	 */
	function mb_check_encoding(array|string|null $value = null, string|null $encoding = null): bool {}
	 ...
	 * @param string|null $encoding <p>The <code>encoding</code> parameter is the character encoding. If it is omitted or <b><code>null</code></b>, the internal character encoding value will be used.</p>
	 ...
	 * <p>Detects character encoding in <code>string</code> <code>string</code>.</p>
	 * @param string $string <p>The <code>string</code> being detected.</p>
	 * @param array|string|null $encodings <p><code>encodings</code> is list of character encoding. Encoding order may be specified by array or comma separated list string.</p> <p>If <code>encodings</code> is omitted or <b><code>null</code></b>, detect_order is used.</p>
	 ...
	 * @return string|false <p>The detected character encoding or <b><code>false</code></b> if the encoding cannot be detected from the given string.</p>
	 ...
	 * @param string|null $charset <p><code>charset</code> specifies the name of the character set in which <code>string</code> is represented in. The default value is determined by the current NLS setting (<code>mbstring.language</code>).</p>
	 * @param string|null $transfer_encoding <p><code>transfer_encoding</code> specifies the scheme of MIME encoding. It should be either <code>"B"</code> (Base64) or <code>"Q"</code> (Quoted-Printable). Falls back to <code>"B"</code> if not given.</p>
	 ...
	 * @param string|null $options <p>The search option. See <code>mb_regex_set_options()</code> for explanation.</p>
	 ...
	 * @param string|null $options The search option. See <code>mb_regex_set_options()</code> for explanation.
	 ...
	 */
	function mb_ereg_replace_callback(string $pattern, callable $callback, string $string, string|null $options = null): string|false|null {}

	/**
	 * Multibyte regular expression match for predefined multibyte string
	 * <p>Performs a multibyte regular expression match for a predefined multibyte string.</p>
	 * @param string|null $pattern <p>The search pattern.</p>
	 * @param string|null $options <p>The search option. See <code>mb_regex_set_options()</code> for explanation.</p>
	 ...
	 * @param string|null $type <p>Input string specifies the input type. <code>"G"</code> for GET, <code>"P"</code> for POST, <code>"C"</code> for COOKIE, <code>"S"</code> for string, <code>"L"</code> for list, and <code>"I"</code> for the whole list (will return <code>array</code>). If type is omitted, it returns the last input type processed.</p>
	 ...
	 * @param string|null $encoding <p>If <code>encoding</code> is set, <b>mb_http_output()</b> sets the HTTP output character encoding to <code>encoding</code>.</p> <p>If <code>encoding</code> is omitted, <b>mb_http_output()</b> returns the current HTTP output character encoding.</p>
	 ...
	 * @since PHP 4 >= 4.0.6, PHP 5, PHP 7
	 */
	function mb_http_output(string|null $encoding = null): string|bool {}

	/**
	 * Set/Get internal character encoding
	 * <p>Set/Get the internal character encoding</p>
	 * @param string|null $encoding <p><code>encoding</code> is the character encoding name used for the HTTP input character encoding conversion, HTTP output character encoding conversion, and the default character encoding for string functions defined by the mbstring module. You should notice that the internal encoding is totally different from the one for multibyte regex.</p>
	 ...
	 * @since PHP 4 >= 4.0.6, PHP 5, PHP 7
	 */
	function mb_language(string|null $language = null): string|bool {}
	 ...
	 * @param string|null $encoding <p>The <code>encoding</code> parameter is the character encoding. If it is omitted or <b><code>null</code></b>, the internal character encoding value will be used.</p> <p>A string specifying one of the supported encodings.</p>
	 * @return array <p><b>mb_str_split()</b> returns an array of strings.</p>
	 * @link https://php.net/manual/en/function.mb-str-split.php
	 * @see str_split()
	 * @since PHP 7 >= 7.4.0
	 */
	function mb_str_split(string $string, int $length = 1, string|null $encoding = null): array {}
	 ...
	 * <p>Truncates <code>string</code> <code>string</code> to specified <code>width</code>.</p>
	 * @param string $string <p>The <code>string</code> being decoded.</p>
	 ...
	 * @param string|null $encoding <p>Character encoding name to use. If it is omitted, internal character encoding is used.</p>
	 ...
	 */
	function mb_stripos(string $haystack, string $needle, int $offset = 0, string|null $encoding = null): int|false {}
	 ...
	 * @since PHP 4 >= 4.0.6, PHP 5, PHP 7
	 */
	function mb_strlen(string $string, string|null $encoding = null): int {}
	 ...
	 * @since PHP 4 >= 4.0.6, PHP 5, PHP 7
	 */
	function mb_strpos(string $haystack, string $needle, int $offset = 0, string|null $encoding = null): int|false {}
	 ...
	 * @since PHP 5 >= 5.2.0, PHP 7
	 */
	function mb_strripos(string $haystack, string $needle, int $offset = 0, string|null $encoding = null): int|false {}
	 ...
	 * @since PHP 4 >= 4.0.6, PHP 5, PHP 7
	 */
	function mb_strrpos(string $haystack, string $needle, int $offset = 0, string|null $encoding = null): int|false {}
	 ...
	 * @since PHP 4 >= 4.0.6, PHP 5, PHP 7
	 */
	function mb_strwidth(string $string, string|null $encoding = null): int {}
	 ...
	 * @param int|null $length <p>Maximum number of characters to use from <code>string</code>. If omitted or <code>NULL</code> is passed, extract all characters to the end of the string.</p>
	 * @param string|null $encoding <p>The <code>encoding</code> parameter is the character encoding. If it is omitted or <b><code>null</code></b>, the internal character encoding value will be used.</p>
	 ...
	 * @since PHP 4 >= 4.3.0, PHP 5, PHP 7
	 */
	function mb_substr_count(string $haystack, string $needle, string|null $encoding = null): int {}
