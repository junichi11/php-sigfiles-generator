...
namespace {
	 ...
	 * @param ?callable $callback <p>The function to be called when an uncaught exception occurs. This handler function needs to accept one parameter, which will be the <code>Throwable</code> object that was thrown. Both <code>Error</code> and <code>Exception</code> implement the <code>Throwable</code> interface. This is the handler signature:</p> <p></p> handler(<code>Throwable</code> <code>$ex</code>): void <p><b><code>null</code></b> may be passed instead, to reset this handler to its default state.</p>
