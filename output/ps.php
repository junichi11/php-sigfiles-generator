...
namespace {
	 ...
	 * @param string $dest <p>The parameter <code>dest</code> determines how the document is being viewed. It can be <i>fitpage</i>, <i>fitwidth</i>, <i>fitheight</i>, or <i>fitbbox</i>.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 ...
	 * @param string $icon <p>The icon shown if the note is folded. This parameter can be set to <i>comment</i>, <i>insert</i>, <i>note</i>, <i>paragraph</i>, <i>newparagraph</i>, <i>key</i>, or <i>help</i>.</p>
	 ...
	 * @param float $urx <p>The x-coordinate of the upper right corner.</p>
	 * @param float $ury <p>The y-coordinate of the upper right corner.</p>
	 * @param string $url <p>The url of the hyperlink to be opened when clicking on this link, e.g. <i>http://www.php.net</i>.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	...
	/**
	 * Start a new pattern
	 * <p>Starts a new pattern. A pattern is like a page containing e.g. a drawing which can be used for filling areas. It is used like a color by calling <code>ps_setcolor()</code> and setting the color space to <i>pattern</i>.</p>
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 ...
	 * @return int <p>The identifier of the pattern or <b><code>FALSE</code></b> on failure.</p>
	 ...
	 * @return array <p>An array of integers indicating the position of possible breaks in the text or <b><code>FALSE</code></b> on failure.</p>
	 ...
	 * @return resource <p>Resource of PostScript document or <b><code>FALSE</code></b> on failure. The return value is passed to all other functions as the first argument.</p>
	 ...
	 * <p>Reads an image which is already available in memory. The parameter <code>source</code> is currently not evaluated and assumed to be <i>memory</i>. The image data is a sequence of pixels starting in th upper left corner and ending in the lower right corner. Each pixel consists of <code>components</code> color components, and each component has <code>bpc</code> bits.</p>
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 * @param string $type <p>The type of the image. Possible values are <i>png</i>, <i>jpeg</i>, or <i>eps</i>.</p>
	 ...
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 * @param string $style <p><code>style</code> can be <i>solid</i> or <i>dashed</i>.</p>
	 ...
	 * <p>Set the position for the next text output. You may alternatively set the x and y value separately by calling <code>ps_set_value()</code> and choosing <i>textx</i> respectively <i>texty</i> as the value name.</p><p>If you want to output text at a certain position it is more convenient to use <code>ps_show_xy()</code> instead of setting the text position and calling <code>ps_show()</code>.</p>
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 ...
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 * @param string $type <p>The parameter <code>type</code> can be <i>both</i>, <i>fill</i>, or <i>fillstroke</i>.</p>
	 * @param string $colorspace <p>The colorspace should be one of <i>gray</i>, <i>rgb</i>, <i>cmyk</i>, <i>spot</i>, <i>pattern</i>. Depending on the colorspace either only the first, the first three or all parameters will be used.</p>
	 ...
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 * @param int $type <p>The type of line ends. Possible values are <i>PS_LINECAP_BUTT</i>, <i>PS_LINECAP_ROUND</i>, or <i>PS_LINECAP_SQUARED</i>.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 ...
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 * @param int $type <p>The way lines are joined. Possible values are <i>PS_LINEJOIN_MITER</i>, <i>PS_LINEJOIN_ROUND</i>, or <i>PS_LINEJOIN_BEVEL</i>.</p>
	 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	 ...
	 * <p>If two lines join in a small angle and the line join is set to <i>PS_LINEJOIN_MITER</i>, then the resulting spike will be very long. The miter limit is the maximum ratio of the miter length (the length of the spike) and the line width.</p>
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 ...
	 * <p>Creates a shading, which can be used by <code>ps_shfill()</code> or <code>ps_shading_pattern()</code>.</p><p>The color of the shading can be in any color space except for <i>pattern</i>.</p>
	 * @param resource $psdoc <p>Resource identifier of the postscript file as returned by <code>ps_new()</code>.</p>
	 * @param string $type <p>The type of shading can be either <i>radial</i> or <i>axial</i>. Each shading starts with the current fill color and ends with the given color values passed in the parameters <code>c1</code> to <code>c4</code> (see <code>ps_setcolor()</code> for their meaning).</p>
	 * @param float $x0
	 * @param float $y0
	 * @param float $x1
	 * @param float $y1
	 ...
	 * @param float $c3
	 * @param float $c4
	 * @param string $optlist <p>If the shading is of type <i>radial</i> the <code>optlist</code> must also contain the parameters <i>r0</i> and <i>r1</i> with the radius of the start and end circle.</p>
	 * @return int <p>Returns the identifier of the pattern or <b><code>FALSE</code></b> on failure.</p>
