...
namespace {
	 ...
	 * @link https://php.net/manual/en/class.v8js.php
	...
	class V8Js {
		 ...
		 * @link https://php.net/manual/en/v8js.getextensions.php
		 * @since PECL v8js >= 0.1.0
		 */
	...
	/**
	 * @link https://php.net/manual/en/class.v8jsexception.php
	 * @since PECL v8js >= 0.1.0
	 */
	class V8JsException extends \Exception {
		...
		/**
		 * @var mixed
		 * @link https://php.net/manual/en/class.v8jsexception.php#v8jsexception.props.jsfilename
		 */
		protected $JsFileName;

		/**
		 * @var mixed
		 * @link https://php.net/manual/en/class.v8jsexception.php#v8jsexception.props.jslinenumber
		 */
		protected $JsLineNumber;

		/**
		 * @var mixed
		 * @link https://php.net/manual/en/class.v8jsexception.php#v8jsexception.props.jssourceline
		 */
		protected $JsSourceLine;

		/**
		 * @var mixed
		 * @link https://php.net/manual/en/class.v8jsexception.php#v8jsexception.props.jstrace
		 */
		protected $JsTrace;
		 ...
		 * @return string
		 * @link https://php.net/manual/en/v8jsexception.getjsfilename.php
		 * @since PECL v8js >= 0.1.0
		 */
		 ...
		 * <p></p><p>This function is currently not documented; only its argument list is available.</p>
		 * @return int
		 * @link https://php.net/manual/en/v8jsexception.getjslinenumber.php
		 * @since PECL v8js >= 0.1.0
		 */
		 ...
		 * <p></p><p>This function is currently not documented; only its argument list is available.</p>
		 * @return string
		 * @link https://php.net/manual/en/v8jsexception.getjssourceline.php
		 * @since PECL v8js >= 0.1.0
		 */
		 ...
		 * <p></p><p>This function is currently not documented; only its argument list is available.</p>
		 * @return string
		 * @link https://php.net/manual/en/v8jsexception.getjstrace.php
		 * @since PECL v8js >= 0.1.0
		 */
