...
namespace {
	 ...
	 * @return string <p>Returns the contents of the current session encoded.</p>
	 ...
	 * @return string <p>Returns the path of the current directory used for data storage.</p>
	 ...
	 * <p>Set cookie parameters defined in the php.ini file. The effect of this function only lasts for the duration of the script. Thus, you need to call <b>session_set_cookie_params()</b> for every request and before <code>session_start()</code> is called.</p><p>This function updates the runtime ini values of the corresponding PHP ini configuration keys which can be retrieved with the <code>ini_get()</code>.</p>
	 * @param int $lifetime <p>Lifetime of the session cookie, defined in seconds.</p>
