...
namespace {
	...
	class mysqli {
		 ...
		 * <p>Returns the number of rows affected by the last <i>INSERT</i>, <i>UPDATE</i>, <i>REPLACE</i> or <i>DELETE</i> query.</p><p>For SELECT statements <b>mysqli_affected_rows()</b> works like <code>mysqli_num_rows()</code>.</p>
		 * @var int <p>An integer greater than zero indicates the number of rows affected or retrieved. Zero indicates that no records were updated for an UPDATE statement, no rows matched the <i>WHERE</i> clause in the query or that no query has yet been executed. -1 indicates that the query returned an error.</p><p><b>Note</b>:</p><p>If the number of affected rows is greater than the maximum integer value(<b><code> PHP_INT_MAX </code></b>), the number of affected rows will be returned as a string.</p>
		 ...
		 * @var int <p>A number that represents the MySQL client library version in format: <i>main_version&#42;10000 + minor_version &#42;100 + sub_version</i>. For example, 4.1.0 is returned as 40100.</p><p>This is useful to quickly determine the version of the client library to know if some capability exists.</p>
		 ...
		 * @var int <p>An integer representing the server version.</p><p>The form of this version number is <i>main_version &#42; 10000 + minor_version &#42; 100 + sub_version</i> (i.e. version 4.1.0 is 40100).</p>
		 ...
		 * @var mixed <p>The value of the <i>AUTO_INCREMENT</i> field that was updated by the previous query. Returns zero if there was no previous query on the connection or if the query did not update an <i>AUTO_INCREMENT</i> value.</p><p><b>Note</b>:</p><p>If the number is greater than maximal int value, <b>mysqli_insert_id()</b> will return a string.</p>
		 ...
		 * <p>Returns a string containing the SQLSTATE error code for the last error. The error code consists of five characters. <i>'00000'</i> means no error. The values are specified by ANSI SQL and ODBC. For a list of possible values, see http://dev.mysql.com/doc/mysql/en/error-handling.html.</p><p><b>Note</b>:</p><p>Note that not all MySQL errors are yet mapped to SQLSTATE's. The value <i>HY000</i> (general error) is used for unmapped errors.</p>
		 * @var string <p>Returns a string containing the SQLSTATE error code for the last error. The error code consists of five characters. <i>'00000'</i> means no error.</p>
		 ...
		 * <p>Returns the number of warnings from the last query in the connection.</p><p><b>Note</b>:</p><p>For retrieving warning messages you can use the SQL command <i>SHOW WARNINGS [limit row_count]</i>.</p>
		 ...
		 * @param string $host <p>Can be either a host name or an IP address. Passing the <b><code>NULL</code></b> value or the string "localhost" to this parameter, the local host is assumed. When possible, pipes will be used instead of the TCP/IP protocol.</p> <p>Prepending host by <i>p:</i> opens a persistent connection. <code>mysqli_change_user()</code> is automatically called on connections opened from the connection pool.</p>
		 ...
		 * <p>Turns on or off auto-commit mode on queries for the database connection.</p><p>To determine the current state of autocommit use the SQL command <i>SELECT @@autocommit</i>.</p>
		 ...
		 * @param string $name <p>If provided then <i>COMMIT/&#42;name&#42;/</i> is executed.</p>
		 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
		 ...
		 * @param string $escapestr <p>The string to be escaped.</p> <p>Characters encoded are <i>NUL (ASCII 0), \n, \r, \, ', ", and Control-Z</i>.</p>
		 ...
		 * <p>This function is used to ask the server to kill a MySQL thread specified by the <code>processid</code> parameter. This value must be retrieved by calling the <code>mysqli_thread_id()</code> function.</p><p>To stop a running query you should use the SQL command <i>KILL QUERY processid</i>.</p>
		 * @param int $processid
		 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
		 ...
		 * @return bool <p>Returns <b><code>TRUE</code></b> if one or more result sets are available from a previous call to <code>mysqli_multi_query()</code>, otherwise <b><code>FALSE</code></b>.</p>
		 ...
		 * @param int $option <p>The option that you want to set. It can be one of the following values:</p> <b>Valid options</b>   Name Description     <b><code>MYSQLI_OPT_CONNECT_TIMEOUT</code></b> connection timeout in seconds (supported on Windows with TCP/IP since PHP 5.3.1)   <b><code>MYSQLI_OPT_LOCAL_INFILE</code></b> enable/disable use of <i>LOAD LOCAL INFILE</i>   <b><code>MYSQLI_INIT_COMMAND</code></b> command to execute after when connecting to MySQL server   <b><code>MYSQLI_READ_DEFAULT_FILE</code></b>  Read options from named option file instead of my.cnf    <b><code>MYSQLI_READ_DEFAULT_GROUP</code></b>  Read options from the named group from my.cnf or the file specified with <b><code>MYSQL_READ_DEFAULT_FILE</code></b>.    <b><code>MYSQLI_SERVER_PUBLIC_KEY</code></b>  RSA public key file used with the SHA-256 based authentication.    <b><code>MYSQLI_OPT_NET_CMD_BUFFER_SIZE</code></b>  The size of the internal command/network buffer. Only valid for mysqlnd.    <b><code>MYSQLI_OPT_NET_READ_BUFFER_SIZE</code></b>  Maximum read chunk size in bytes when reading the body of a MySQL command packet. Only valid for mysqlnd.    <b><code>MYSQLI_OPT_INT_AND_FLOAT_NATIVE</code></b>  Convert integer and float columns back to PHP numbers. Only valid for mysqlnd.    <b><code>MYSQLI_OPT_SSL_VERIFY_SERVER_CERT</code></b>
		 ...
		 * @param array $error <p>List of connections on which an error occured, for example, query failure or lost connection.</p>
		 ...
		 * @param string $query <p>The query, as a string.</p> <p><b>Note</b>:</p><p>You should not add a terminating semicolon or <i>\g</i> to the statement.</p>  <p>This parameter can include one or more parameter markers in the SQL statement by embedding question mark (<i>&#63;</i>) characters at the appropriate positions.</p> <p><b>Note</b>:</p><p>The markers are legal only in certain places in SQL statements. For example, they are allowed in the <i>VALUES()</i> list of an <i>INSERT</i> statement (to specify column values for a row), or in a comparison with a column in a <i>WHERE</i> clause to specify a comparison value.</p> <p>However, they are not allowed for identifiers (such as table or column names), in the select list that names the columns to be returned by a <i>SELECT</i> statement, or to specify both operands of a binary operator such as the <i>=</i> equal sign. The latter restriction is necessary because it would be impossible to determine the parameter type. It's not allowed to compare marker with <i>NULL</i> by <i>&#63; IS NULL</i> too. In general, parameters are legal only in Data Manipulation Language (DML) statements, and not in Data Definition Language (DDL) statements.</p>
		...
		/**
		 * Performs a query on the database
		 * <p>Performs a <code>query</code> against the database.</p><p>For non-DML queries (not INSERT, UPDATE or DELETE), this function is similar to calling <code>mysqli_real_query()</code> followed by either <code>mysqli_use_result()</code> or <code>mysqli_store_result()</code>.</p><p><b>Note</b>:</p><p>In the case where you pass a statement to <b>mysqli_query()</b> that is longer than <i>max_allowed_packet</i> of the server, the returned error codes are different depending on whether you are using MySQL Native Driver (<i>mysqlnd</i>) or MySQL Client Library (<i>libmysqlclient</i>). The behavior is as follows:</p><p><i>mysqlnd</i> on Linux returns an error code of 1153. The error message means "got a packet bigger than <i>max_allowed_packet</i> bytes".</p><p><i>mysqlnd</i> on Windows returns an error code 2006. This error message means "server has gone away".</p><p><i>libmysqlclient</i> on all platforms returns an error code 2006. This error message means "server has gone away".</p>
		 * @param string $query <p>The query string.</p> <p>Data inside the query should be properly escaped.</p>
		 * @param int $resultmode <p>Either the constant <b><code>MYSQLI_USE_RESULT</code></b> or <b><code>MYSQLI_STORE_RESULT</code></b> depending on the desired behavior. By default, <b><code>MYSQLI_STORE_RESULT</code></b> is used.</p> <p>If you use <b><code>MYSQLI_USE_RESULT</code></b> all subsequent calls will return error <i>Commands out of sync</i> unless you call <code>mysqli_free_result()</code></p> <p>With <b><code>MYSQLI_ASYNC</code></b> (available with mysqlnd), it is possible to perform query asynchronously. <code>mysqli_poll()</code> is then used to get results from such queries.</p>
		 ...
		 * @param int $flags <p>A bitmask of <b><code>MYSQLI_TRANS_COR_&#42;</code></b> constants.</p>
		 * @param string $name <p>If provided then <i>ROLLBACK/&#42;name&#42;/</i> is executed.</p>
		 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
		 ...
		 * <p>Returns <b><code>MYSQLI_RPL_MASTER</code></b>, <b><code>MYSQLI_RPL_SLAVE</code></b> or <b><code>MYSQLI_RPL_ADMIN</code></b> depending on a query type. <i>INSERT</i>, <i>UPDATE</i> and similar are <i>master</i> queries, <i>SELECT</i> is <i>slave</i>, and <i>FLUSH</i>, <i>REPAIR</i> and similar are <i>admin</i>.</p><p>This function is currently not documented; only its argument list is available.</p><p>This function has been <i>DEPRECATED</i> and <i>REMOVED</i> as of PHP 5.3.0.</p>
		 * @param string $query
		 * @return int
		 ...
		 * <p>This function is currently not documented; only its argument list is available.</p><p>This function has been <i>DEPRECATED</i> and <i>REMOVED</i> as of PHP 5.3.0.</p>
		 * @param string $query
		 * @return bool
		 ...
		 * <p>Deactivates a <i>LOAD DATA INFILE LOCAL</i> handler previously set with <code>mysqli_set_local_infile_handler()</code>.</p>
		 ...
		 * <p>Set callback function for LOAD DATA LOCAL INFILE command</p><p>The callbacks task is to read input from the file specified in the <i>LOAD DATA LOCAL INFILE</i> and to reformat it into the format understood by <i>LOAD DATA INFILE</i>.</p><p>The returned data needs to match the format specified in the <i>LOAD DATA</i></p>
		 * @param \mysqli $link <p>A link identifier returned by <code>mysqli_connect()</code> or <code>mysqli_init()</code></p>
		 * @param callable $read_func <p>A callback function or object method taking the following parameters:</p>   <code>stream</code>  <p>A PHP stream associated with the SQL commands INFILE</p>  <code>&amp;buffer</code>  <p>A string buffer to store the rewritten input into</p>  <code>buflen</code>  <p>The maximum number of characters to be stored in the buffer</p>  <code>&amp;errormsg</code>  <p>If an error occurs you can store an error message in here</p>
		 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
	...
	class mysqli_driver {
		...
		/**
		 * @var string <p>Whether MySQLi Embedded support is enabled</p>
	...
	class mysqli_result implements \Traversable {
		 ...
		 * @param int $fieldnr <p>The field number. This value must be in the range from <i>0</i> to <i>number of fields - 1</i>.</p>
	...
	class mysqli_stmt {
		 ...
		 * <p>Returns the number of rows affected by <i>INSERT</i>, <i>UPDATE</i>, or <i>DELETE</i> query.</p><p>This function only works with queries which update a table. In order to get the number of rows from a SELECT query, use <code>mysqli_stmt_num_rows()</code> instead.</p>
		 ...
		 * @param int $attr <p>The attribute that you want to set. It can have one of the following values:</p> <b>Attribute values</b>   Character Description     MYSQLI_STMT_ATTR_UPDATE_MAX_LENGTH  Setting to <b><code>TRUE</code></b> causes <code>mysqli_stmt_store_result()</code> to update the metadata <i>MYSQL_FIELD-&gt;max_length</i> value.    MYSQLI_STMT_ATTR_CURSOR_TYPE  Type of cursor to open for statement when <code>mysqli_stmt_execute()</code> is invoked. <code>mode</code> can be <i>MYSQLI_CURSOR_TYPE_NO_CURSOR</i> (the default) or <i>MYSQLI_CURSOR_TYPE_READ_ONLY</i>.    MYSQLI_STMT_ATTR_PREFETCH_ROWS  Number of rows to fetch from server at a time when using a cursor. <code>mode</code> can be in the range from 1 to the maximum value of unsigned long. The default is 1.     <p>If you use the <i>MYSQLI_STMT_ATTR_CURSOR_TYPE</i> option with <i>MYSQLI_CURSOR_TYPE_READ_ONLY</i>, a cursor is opened for the statement when you invoke <code>mysqli_stmt_execute()</code>. If there is already an open cursor from a previous <code>mysqli_stmt_execute()</code> call, it closes the cursor before opening a new one. <code>mysqli_stmt_reset()</code> also closes any open cursor before preparing the statement for re-execution. <code>mysqli_stmt_free_result()</code> closes any open cursor.</p> <p>If you open a cursor for a prepared statement, <code>mysqli_stmt_store_result()</code> is unnecessary.</p>
		 ...
		 * @param mixed $var1 <p>The number of variables and length of string <code>types</code> must match the parameters in the statement.</p>
		 * @param mixed $_
		 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
		 ...
		 * <p>Binds columns in the result set to variables.</p><p>When <code>mysqli_stmt_fetch()</code> is called to fetch data, the MySQL client/server protocol places the data for the bound columns into the specified variables <code>var1, ...</code>.</p><p><b>Note</b>:</p><p>Note that all columns must be bound after <code>mysqli_stmt_execute()</code> and prior to calling <code>mysqli_stmt_fetch()</code>. Depending on column types bound variables can silently change to the corresponding PHP type.</p><p>A column can be bound or rebound at any time, even after a result set has been partially retrieved. The new binding takes effect the next time <code>mysqli_stmt_fetch()</code> is called.</p>
		 * @param mixed $var1 <p>The variable to be bound.</p>
		 * @param mixed $_
		 * @return bool <p>Returns <b><code>TRUE</code></b> on success or <b><code>FALSE</code></b> on failure.</p>
		...
		/**
		 * Prepare an SQL statement for execution
		 * <p>Prepares the SQL query pointed to by the null-terminated string query.</p><p>The parameter markers must be bound to application variables using <code>mysqli_stmt_bind_param()</code> and/or <code>mysqli_stmt_bind_result()</code> before executing the statement or fetching rows.</p><p><b>Note</b>:</p><p>In the case where you pass a statement to <b>mysqli_stmt_prepare()</b> that is longer than <i>max_allowed_packet</i> of the server, the returned error codes are different depending on whether you are using MySQL Native Driver (<i>mysqlnd</i>) or MySQL Client Library (<i>libmysqlclient</i>). The behavior is as follows:</p><p><i>mysqlnd</i> on Linux returns an error code of 1153. The error message means "got a packet bigger than <i>max_allowed_packet</i> bytes".</p><p><i>mysqlnd</i> on Windows returns an error code 2006. This error message means "server has gone away".</p><p><i>libmysqlclient</i> on all platforms returns an error code 2006. This error message means "server has gone away".</p>
		 * @param string $query <p>The query, as a string. It must consist of a single SQL statement.</p> <p>You can include one or more parameter markers in the SQL statement by embedding question mark (<i>&#63;</i>) characters at the appropriate positions.</p> <p><b>Note</b>:</p><p>You should not add a terminating semicolon or <i>\g</i> to the statement.</p>  <p><b>Note</b>:</p><p>The markers are legal only in certain places in SQL statements. For example, they are allowed in the VALUES() list of an INSERT statement (to specify column values for a row), or in a comparison with a column in a WHERE clause to specify a comparison value.</p> <p>However, they are not allowed for identifiers (such as table or column names), in the select list that names the columns to be returned by a SELECT statement), or to specify both operands of a binary operator such as the <i>=</i> equal sign. The latter restriction is necessary because it would be impossible to determine the parameter type. In general, parameters are legal only in Data Manipulation Language (DML) statements, and not in Data Definition Language (DDL) statements.</p>
		...
		/**
		 * Send data in blocks
		 * <p>Allows to send parameter data to the server in pieces (or chunks), e.g. if the size of a blob exceeds the size of <i>max_allowed_packet</i>. This function can be called multiple times to send the parts of a character or binary data value for a column, which must be one of the TEXT or BLOB datatypes.</p>
	 ...
	 * <p>Returns the number of rows affected by the last <i>INSERT</i>, <i>UPDATE</i>, <i>REPLACE</i> or <i>DELETE</i> query.</p><p>For SELECT statements <b>mysqli_affected_rows()</b> works like <code>mysqli_num_rows()</code>.</p>
	 * @param \mysqli $link <p>A link identifier returned by <code>mysqli_connect()</code> or <code>mysqli_init()</code></p>
	 * @return int <p>An integer greater than zero indicates the number of rows affected or retrieved. Zero indicates that no records were updated for an UPDATE statement, no rows matched the <i>WHERE</i> clause in the query or that no query has yet been executed. -1 indicates that the query returned an error.</p><p><b>Note</b>:</p><p>If the number of affected rows is greater than the maximum integer value(<b><code> PHP_INT_MAX </code></b>), the number of affected rows will be returned as a string.</p>
	 * @link http://php.net/manual/en/mysqli.affected-rows.php
	 * @see mysqli_num_rows(), mysqli_info()
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * <p>This function is an alias of <code>mysqli_stmt_bind_param()</code>.</p><p>This function has been <i>DEPRECATED</i> as of PHP 5.3.0 and <i>REMOVED</i> as of PHP 5.4.0.</p>
	 ...
	 * @since PHP 5 < 5.4.0
	 */
	function mysqli_bind_param(\mysqli_stmt $stmt, string $types, &$var1, &$_ = NULL): bool {}

	/**
	 * Alias for mysqli_stmt_bind_result()
	 * <p>This function is an alias of <code>mysqli_stmt_bind_result()</code>.</p><p>This function has been <i>DEPRECATED</i> as of PHP 5.3.0 and <i>REMOVED</i> as of PHP 5.4.0.</p>
	 * @param \mysqli_stmt $stmt <p>A statement identifier returned by <code>mysqli_stmt_init()</code>.</p>
	 * @param mixed $var1 <p>The variable to be bound.</p>
	 * @param mixed $_
	 * @return bool
	 ...
	 * @since PHP 5 < 5.4.0
	 */
	function mysqli_bind_result(\mysqli_stmt $stmt, &$var1, &$_ = NULL): bool {}
	 ...
	 * <p>This function is an alias of <code>mysqli_character_set_name()</code>.</p><p>This function has been <i>DEPRECATED</i> as of PHP 5.3.0 and <i>REMOVED</i> as of PHP 5.4.0.</p>
	 * @param \mysqli $link <p>A link identifier returned by <code>mysqli_connect()</code> or <code>mysqli_init()</code></p>
	 * @return string
	 * @link http://php.net/manual/en/function.mysqli-client-encoding.php
	 * @since PHP 5 < 5.4.0
	 */
	function mysqli_client_encoding(\mysqli $link): string {}
	 ...
	 * <p>This function is an alias of <code>mysqli_stmt_fetch()</code>.</p><p>This function has been <i>DEPRECATED</i> as of PHP 5.3.0 and <i>REMOVED</i> as of PHP 5.4.0.</p>
	 * @param \mysqli_stmt $stmt <p>A statement identifier returned by <code>mysqli_stmt_init()</code>.</p>
	 * @return bool
	 * @link http://php.net/manual/en/function.mysqli-fetch.php
	 * @since PHP 5 < 5.4.0
	 */
	function mysqli_fetch(\mysqli_stmt $stmt): bool {}
	 ...
	 * <p>Returns an empty array. Available only with mysqlnd.</p>
	 * @return array <p>Returns an empty array on success, <b><code>FALSE</code></b> otherwise.</p>
	 * @link http://php.net/manual/en/function.mysqli-get-cache-stats.php
	 ...
	 * <p>Returns client version number as an integer.</p>
	 * @param \mysqli $link
	 * @return int <p>A number that represents the MySQL client library version in format: <i>main_version&#42;10000 + minor_version &#42;100 + sub_version</i>. For example, 4.1.0 is returned as 40100.</p><p>This is useful to quickly determine the version of the client library to know if some capability exists.</p>
	 * @link http://php.net/manual/en/mysqli.get-client-version.php
	 * @see mysqli_get_client_info(), mysqli_get_server_info(), mysqli_get_server_version()
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * <p>This function is an alias of <code>mysqli_stmt_result_metadata()</code>.</p><p>This function has been <i>DEPRECATED</i> as of PHP 5.3.0 and <i>REMOVED</i> as of PHP 5.4.0.</p>
	 * @param \mysqli_stmt $stmt <p>A statement identifier returned by <code>mysqli_stmt_init()</code>.</p>
	 * @return mysqli_result
	 * @link http://php.net/manual/en/function.mysqli-get-metadata.php
	 * @since PHP 5 < 5.4.0
	 */
	function mysqli_get_metadata(\mysqli_stmt $stmt): \mysqli_result {}
	 ...
	 * <p>The <b>mysqli_get_server_version()</b> function returns the version of the server connected to (represented by the <code>link</code> parameter) as an integer.</p>
	 * @param \mysqli $link <p>A link identifier returned by <code>mysqli_connect()</code> or <code>mysqli_init()</code></p>
	 * @return int <p>An integer representing the server version.</p><p>The form of this version number is <i>main_version &#42; 10000 + minor_version &#42; 100 + sub_version</i> (i.e. version 4.1.0 is 40100).</p>
	 * @link http://php.net/manual/en/mysqli.get-server-version.php
	 * @see mysqli_get_client_info(), mysqli_get_client_version(), mysqli_get_server_info()
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * <p>The <b>mysqli_insert_id()</b> function returns the ID generated by a query (usually INSERT) on a table with a column having the AUTO_INCREMENT attribute. If no INSERT or UPDATE statements were sent via this connection, or if the modified table does not have a column with the AUTO_INCREMENT attribute, this function will return zero.</p><p><b>Note</b>:</p><p>Performing an INSERT or UPDATE statement using the LAST_INSERT_ID() function will also modify the value returned by the <b>mysqli_insert_id()</b> function.</p>
	 * @param \mysqli $link <p>A link identifier returned by <code>mysqli_connect()</code> or <code>mysqli_init()</code></p>
	 * @return mixed <p>The value of the <i>AUTO_INCREMENT</i> field that was updated by the previous query. Returns zero if there was no previous query on the connection or if the query did not update an <i>AUTO_INCREMENT</i> value.</p><p><b>Note</b>:</p><p>If the number is greater than maximal int value, <b>mysqli_insert_id()</b> will return a string.</p>
	 * @link http://php.net/manual/en/mysqli.insert-id.php
	 * @since PHP 5, PHP 7
	 */
	 ...
	 * <p>This function is an alias of <code>mysqli_stmt_param_count()</code>.</p><p>This function has been <i>DEPRECATED</i> as of PHP 5.3.0 and <i>REMOVED</i> as of PHP 5.4.0.</p>
	 * @param \mysqli_stmt $stmt <p>A statement identifier returned by <code>mysqli_stmt_init()</code>.</p>
	 * @return int
	 * @link http://php.net/manual/en/function.mysqli-param-count.php
	 * @since PHP 5 < 5.4.0
	 */
	function mysqli_param_count(\mysqli_stmt $stmt): int {}
	 ...
	 * Refreshes
	 * <p>Flushes tables or caches, or resets the replication server information.</p>
	 * @param resource $link <p>A link identifier returned by <code>mysqli_connect()</code> or <code>mysqli_init()</code></p>
	 * @param int $options <p>The options to refresh, using the MYSQLI_REFRESH_&#42; constants as documented within the MySQLi constants documentation.</p> <p>See also the official MySQL Refresh documentation.</p>
	 * @return bool <p><b><code>TRUE</code></b> if the refresh was a success, otherwise <b><code>FALSE</code></b></p>
	 * @link http://php.net/manual/en/mysqli.refresh.php
	 * @see mysqli_poll()
	 ...
	 * <p>This function is an alias of <code>mysqli_stmt_send_long_data()</code>.</p><p>This function has been <i>DEPRECATED</i> as of PHP 5.3.0 and <i>REMOVED</i> as of PHP 5.4.0.</p>
	 * @param \mysqli_stmt $stmt <p>A statement identifier returned by <code>mysqli_stmt_init()</code>.</p>
	 * @param int $param_nr <p>Indicates which parameter to associate the data with. Parameters are numbered beginning with 0.</p>
	 * @param string $data <p>A string containing data to be sent.</p>
	 * @return bool
	 ...
	 * @since PHP 5 < 5.4.0
	 */
	function mysqli_send_long_data(\mysqli_stmt $stmt, int $param_nr, string $data): bool {}
	...
	/**
	 * <p>Field is defined as <i>AUTO_INCREMENT</i></p>
	 */
	define('MYSQLI_AUTO_INCREMENT_FLAG', 512);

	/**
	 * <p>Field is defined as <i>BINARY</i>. Available since PHP 5.3.0.</p>
	 */
	define('MYSQLI_BINARY_FLAG', 128);

	/**
	 * <p>Field is defined as <i>BLOB</i></p>
	 */
	...
	/**
	 * <p>Allow <i>interactive_timeout</i> seconds (instead of <i>wait_timeout</i> seconds) of inactivity before closing the connection. The client's session <i>wait_timeout</i> variable will be set to the value of the session <i>interactive_timeout</i> variable.</p>
	 */
	...
	/**
	 * <p>Don't allow the <i>db_name.tbl_name.col_name</i> syntax.</p>
	 */
	...
	/**
	 * <p>Field is defined as <i>ENUM</i>. Available since PHP 5.3.0.</p>
	 */
	define('MYSQLI_ENUM_FLAG', 256);

	/**
	 * <p>Field is part of <i>GROUP BY</i></p>
	 */
	...
	/**
	 * <p>Indicates that a field is defined as <i>NOT NULL</i></p>
	 */
	...
	/**
	 * <p>Field is defined as <i>NUMERIC</i></p>
	 */
	...
	/**
	 * <p>Enables command <i>LOAD LOCAL INFILE</i></p>
	 */
	...
	/**
	 * <p>Flushes the host cache, like executing the <i>FLUSH HOSTS</i> SQL statement.</p>
	 */
	define('MYSQLI_REFRESH_HOSTS', 8);

	/**
	 * <p>Flushes the logs, like executing the <i>FLUSH LOGS</i> SQL statement.</p>
	 */
	define('MYSQLI_REFRESH_LOG', 2);

	/**
	 * <p>On a master replication server: removes the binary log files listed in the binary log index, and truncates the index file. Like executing the <i>RESET MASTER</i> SQL statement.</p>
	 */
	define('MYSQLI_REFRESH_MASTER', 128);

	/**
	 * <p>On a slave replication server: resets the master server information, and restarts the slave. Like executing the <i>RESET SLAVE</i> SQL statement.</p>
	 */
	define('MYSQLI_REFRESH_SLAVE', 64);

	/**
	 * <p>Reset the status variables, like executing the <i>FLUSH STATUS</i> SQL statement.</p>
	 */
	define('MYSQLI_REFRESH_STATUS', 16);

	/**
	 * <p>Flushes the table cache, like executing the <i>FLUSH TABLES</i> SQL statement.</p>
	 */
	...
	/**
	 * <p>Throw a <i>mysqli_sql_exception</i> for errors instead of warnings.</p>
	 */
	...
	/**
	 * <p>Field is defined as <i>SET</i></p>
	 */
	...
	/**
	 * <p>Field is defined as <i>TIMESTAMP</i></p>
	 */
	...
	/**
	 * <p>Field is defined as <i>BIT</i> (MySQL 5.0.3 and up)</p>
	 */
	...
	/**
	 * <p>Field is defined as <i>TINYINT</i>. For <i>CHAR</i>, see <i>MYSQLI_TYPE_STRING</i></p>
	 */
	define('MYSQLI_TYPE_CHAR', 1);

	/**
	 * <p>Field is defined as <i>DATE</i></p>
	 */
	define('MYSQLI_TYPE_DATE', 10);

	/**
	 * <p>Field is defined as <i>DATETIME</i></p>
	 */
	define('MYSQLI_TYPE_DATETIME', 12);

	/**
	 * <p>Field is defined as <i>DECIMAL</i></p>
	 */
	define('MYSQLI_TYPE_DECIMAL', 0);

	/**
	 * <p>Field is defined as <i>DOUBLE</i></p>
	 */
	define('MYSQLI_TYPE_DOUBLE', 5);

	/**
	 * <p>Field is defined as <i>ENUM</i></p>
	 */
	define('MYSQLI_TYPE_ENUM', 247);

	/**
	 * <p>Field is defined as <i>FLOAT</i></p>
	 */
	define('MYSQLI_TYPE_FLOAT', 4);

	/**
	 * <p>Field is defined as <i>GEOMETRY</i></p>
	 */
	define('MYSQLI_TYPE_GEOMETRY', 255);

	/**
	 * <p>Field is defined as <i>MEDIUMINT</i></p>
	 */
	define('MYSQLI_TYPE_INT24', 9);

	/**
	 * <p>Field is defined as <i>INTERVAL</i></p>
	 */
	define('MYSQLI_TYPE_INTERVAL', 247);

	/**
	 * <p>Field is defined as <i>INT</i></p>
	 */
	define('MYSQLI_TYPE_LONG', 3);

	/**
	 * <p>Field is defined as <i>LONGBLOB</i></p>
	 */
	define('MYSQLI_TYPE_LONG_BLOB', 251);

	/**
	 * <p>Field is defined as <i>BIGINT</i></p>
	 */
	define('MYSQLI_TYPE_LONGLONG', 8);

	/**
	 * <p>Field is defined as <i>MEDIUMBLOB</i></p>
	 */
	...
	/**
	 * <p>Precision math <i>DECIMAL</i> or <i>NUMERIC</i> field (MySQL 5.0.3 and up)</p>
	 */
	define('MYSQLI_TYPE_NEWDECIMAL', 246);

	/**
	 * <p>Field is defined as <i>DEFAULT NULL</i></p>
	 */
	...
	/**
	 * <p>Field is defined as <i>SMALLINT</i></p>
	 */
	define('MYSQLI_TYPE_SHORT', 2);

	/**
	 * <p>Field is defined as <i>CHAR</i> or <i>BINARY</i></p>
	 */
	define('MYSQLI_TYPE_STRING', 254);

	/**
	 * <p>Field is defined as <i>TIME</i></p>
	 */
	...
	/**
	 * <p>Field is defined as <i>TINYINT</i></p>
	 */
	define('MYSQLI_TYPE_TINY', 1);

	/**
	 * <p>Field is defined as <i>TINYBLOB</i></p>
	 */
	define('MYSQLI_TYPE_TINY_BLOB', 249);

	/**
	 * <p>Field is defined as <i>VARCHAR</i></p>
	 */
	define('MYSQLI_TYPE_VAR_STRING', 253);

	/**
	 * <p>Field is defined as <i>YEAR</i></p>
	 */
	...
	/**
	 * <p>Field is defined as <i>UNSIGNED</i></p>
	 */
	...
	/**
	 * <p>Field is defined as <i>ZEROFILL</i></p>
	 */
