...
namespace {
	 ...
	 * <p>Decodes a base64 encoded <code>string</code>.</p>
	 * @param string $string <p>The encoded data.</p>
	 ...
	 * <p>Encodes the given <code>string</code> with base64.</p><p>This encoding is designed to make binary data survive transport through transport layers that are not 8-bit clean, such as mail bodies.</p><p>Base64-encoded data takes about 33% more space than the original data.</p>
	 * @param string $string <p>The data to encode.</p>
	 ...
	 * @param bool $associative <p>If the optional <code>associative</code> parameter is set to true, <b>get_headers()</b> parses the response and sets the array's keys.</p>
	 * @param ?resource $context <p>A valid context resource created with <code>stream_context_create()</code>, or <b><code>null</code></b> to use the default context.</p>
	 * @return array|false <p>Returns an indexed or associative array with the headers, or <b><code>false</code></b> on failure.</p>
	 ...
	 * @param string $string <p>The URL to be decoded.</p>
	 ...
	 * @param string $string <p>The string to be decoded.</p>
