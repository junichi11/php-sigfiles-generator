...
namespace {
	 ...
	 * @return int <p>Retuns a pspell config identifier, or <b><code>FALSE</code></b> on error.</p>
	 ...
	 * @return int <p>Returns the dictionary link identifier on success or <b><code>FALSE</code></b> on failure.</p>
	 ...
	 * @return int <p>Returns a dictionary link identifier on success.</p>
	 ...
	 * @param string $encoding <p>The encoding that words are expected to be in. Valid values are <i>utf-8</i>, <i>iso8859-&#42;</i>, <i>koi8-r</i>, <i>viscii</i>, <i>cp1252</i>, <i>machine unsigned 16</i>, <i>machine unsigned 32</i>.</p>
