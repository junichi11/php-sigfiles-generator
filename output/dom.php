...
namespace {
	...
	class DOMAttr extends \DOMNode {
		 ...
		 * @param ?array $xpath <p>An array of <code>xpath</code>s to filter the nodes by.</p>
	...
	/**
	 * <p>The <b>DOMCdataSection</b> inherits from <code>DOMText</code> for textural representation of CData constructs.</p>
	...
	interface DOMChildNode {
		 ...
		 * @param \DOMNode|string $nodes <p>Nodes to be added after the node.</p>
		 * @return void <p>No value is returned.</p>
		 ...
		 * @param \DOMNode|string $nodes <p>Nodes to be added before the node.</p>
		 * @return void <p>No value is returned.</p>
		 ...
		 * <p>Replaces the node with new <code>nodes</code>. A combination of <code>DOMChildNode::remove()</code> and <b>DOMChildNode::append()</b>.</p>
		 * @param \DOMNode|string $nodes <p>The replacement nodes.</p>
		 * @return void <p>No value is returned.</p>
	...
	class DOMDocument extends \DOMNode implements \DOMParentNode {
		 ...
		 * @return DOMDocument|bool <p>Returns <b><code>true</code></b> on success or <b><code>false</code></b> on failure. If called statically, returns a <code>DOMDocument</code> or <b><code>false</code></b> on failure.</p>
		 ...
		 * <p>The function parses the HTML contained in the string <code>source</code>. Unlike loading XML, HTML does not have to be well-formed to load. This function may also be called statically to load and create a <code>DOMDocument</code> object. The static invocation may be used when no <code>DOMDocument</code> properties need to be set prior to loading.</p>
	...
	class DOMElement extends \DOMNode implements \DOMParentNode, \DOMChildNode {
		 ...
		 * @param string $qualifiedName <p>The name of the attribute.</p>
		 * @return DOMAttr|DOMNameSpaceNode|false <p>The attribute node. Note that for XML namespace declarations (<code>xmlns</code> and <code>xmlns:&#42;</code> attributes) an instance of <b>DOMNameSpaceNode</b> is returned instead of a <code>DOMAttr</code>.</p>
		 ...
		 * @param ?string $namespace <p>The namespace URI.</p>
		 * @param string $localName <p>The local name.</p>
		 * @return DOMAttr|DOMNameSpaceNode|null <p>The attribute node. Note that for XML namespace declarations (<code>xmlns</code> and <code>xmlns:&#42;</code> attributes) an instance of <b>DOMNameSpaceNode</b> is returned instead of a <code>DOMAttr</code> object.</p>
	...
	class DOMImplementation {
		 ...
		 * @return DOMDocument|false <p>A new <code>DOMDocument</code> object. If <code>namespace</code>, <code>qualifiedName</code>, and <code>doctype</code> are null, the returned <code>DOMDocument</code> is empty with no document element</p>
		 ...
		 * @return DOMDocumentType|false <p>A new <code>DOMDocumentType</code> node with its <code>ownerDocument</code> set to <b><code>null</code></b>.</p>
	...
	class DOMNodeList implements \IteratorAggregate, \Countable {
		 ...
		 * @return DOMNode|DOMNameSpaceNode|null <p>The node at the <code>index</code>th position in the <code>DOMNodeList</code>, or <b><code>null</code></b> if that is not a valid index.</p>
	...
	interface DOMParentNode {
		 ...
		 * @param \DOMNode|string $nodes <p>The nodes to append.</p>
		 * @return void <p>No value is returned.</p>
		 ...
		 * @param \DOMNode|string $nodes <p>The nodes to prepend.</p>
		 * @return void <p>No value is returned.</p>
	 ...
	 * <p>This function takes the node <code>node</code> of class SimpleXML and makes it into a <code>DOMElement</code> node. This new object can then be used as a native <code>DOMElement</code> node.</p>
	 * @param object $node <p>The <code>SimpleXMLElement</code> node.</p>
	 * @return DOMElement <p>The <code>DOMElement</code> node added.</p>
